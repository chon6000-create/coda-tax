 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function U(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,ml(n,r,t)}function ml(n,e,t){let r=`FIRESTORE (${yn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw Je(r),new Error(r)}function Q(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||ml(e,s,r)}function j(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ks{constructor(e,t,r,s,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,yr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new ks(q.min(),s,new te(H),Xe(),W())}}class yr{constructor(e,t,r,s,o){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new yr(r,t,W(),W(),W())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e="WebChannelConnection",Un=(n,e,t)=>{n.listen(e,(r=>{try{t(r)}catch(s){setTimeout((()=>{throw s}),0)}}))};class on extends Cy{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!on.c_){const e=fl();Un(e,dl.STAT_EVENT,(t=>{t.stat===bi.PROXY?L(_e,"STAT_EVENT: detected buffering proxy"):t.stat===bi.NOPROXY&&L(_e,"STAT_EVENT: detected no buffering proxy")})),on.c_=!0}}zo(e,t,r,s,o){const a=qi();return new Promise(((u,h)=>{const d=new ll;d.setWithCredentials(!0),d.listenOnce(hl.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case Gr.NO_ERROR:const y=d.getResponseJson();L(_e,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(y)),u(y);break;case Gr.TIMEOUT:L(_e,`RPC '${e}' ${a} timed out`),h(new O(C.DEADLINE_EXCEEDED,"Request time out"));break;case Gr.HTTP_ERROR:const w=d.getStatus();if(L(_e,`RPC '${e}' ${a} failed with status:`,w,"response text:",d.getResponseText()),w>0){let V=d.getResponseJson();Array.isArray(V)&&(V=V[0]);const b=V==null?void 0:V.error;if(b&&b.status&&b.message){const P=(function(N){const M=N.toLowerCase().replace(/_/g,"-");return Object.values(C).indexOf(M)>=0?M:C.UNKNOWN})(b.status);h(new O(P,b.message))}else h(new O(C.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new O(C.UNAVAILABLE,"Connection failed."));break;default:U(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{L(_e,`RPC '${e}' ${a} completed.`)}}));const p=JSON.stringify(s);L(_e,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",p,r,15)}))}T_(e,t,r){const s=qi(),o=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Go(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const d=o.join("");L(_e,`Creating RPC '${e}' stream ${s}: ${d}`,u);const p=a.createWebChannel(d,u);this.I_(p);let y=!1,w=!1;const V=new ky({Ho:b=>{w?L(_e,`Not sending because RPC '${e}' stream ${s} is closed:`,b):(y||(L(_e,`Opening RPC '${e}' stream ${s} transport.`),p.open(),y=!0),L(_e,`RPC '${e}' stream ${s} sending:`,b),p.send(b))},Jo:()=>p.close()});return Un(p,$n.EventType.OPEN,(()=>{w||(L(_e,`RPC '${e}' stream ${s} transport opened.`),V.i_())})),Un(p,$n.EventType.CLOSE,(()=>{w||(w=!0,L(_e,`RPC '${e}' stream ${s} transport closed`),V.o_(),this.E_(p))})),Un(p,$n.EventType.ERROR,(b=>{w||(w=!0,qt(_e,`RPC '${e}' stream ${s} transport errored. Name:`,b.name,"Message:",b.message),V.o_(new O(C.UNAVAILABLE,"The operation could not be completed")))})),Un(p,$n.EventType.MESSAGE,(b=>{var P;if(!w){const S=b.data[0];Q(!!S,16349);const N=S,M=(N==null?void 0:N.error)||((P=N[0])==null?void 0:P.error);if(M){L(_e,`RPC '${e}' stream ${s} received error:`,M);const B=M.status;let Y=(function(T){const m=se[T];if(m!==void 0)return Kl(m)})(B),K=M.message;B==="NOT_FOUND"&&K.includes("database")&&K.includes("does not exist")&&K.includes(this.databaseId.database)&&qt(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),Y===void 0&&(Y=C.INTERNAL,K="Unknown error status: "+B+" with message "+M.message),w=!0,V.o_(new O(Y,K)),p.close()}else L(_e,`RPC '${e}' stream ${s} received:`,S),V.__(S)}})),on.u_(),setTimeout((()=>{V.s_()}),0),V}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,r){super.Go(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return pl()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */cn._jsonSchemaVersion="firestore/querySnapshot/1.0",cn._jsonSchema={type:oe("string",cn._jsonSchemaVersion),bundleSource:oe("string","QuerySnapshot"),bundleName:oe("string"),bundle:oe("string")};function GE(n){return qh(sn(n.firestore,ur),[new po(n._key,qe.none())])}function mu(n,e){const t=sn(n.firestore,ur),r=bh(n),s=HE(n.converter,e),o=Nh(n.firestore);return qh(t,[LE(o,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,qe.exists(!1))]).then((()=>r))}function KE(n,...e){var d,p,y;n=Ie(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||du(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(du(e[r])){const w=e[r];e[r]=(d=w.next)==null?void 0:d.bind(w),e[r+1]=(p=w.error)==null?void 0:p.bind(w),e[r+2]=(y=w.complete)==null?void 0:y.bind(w)}let o,a,u;if(n instanceof ce)a=sn(n.firestore,ur),u=ho(n._key.path),o={next:w=>{e[r]&&e[r](QE(a,n,w))},error:e[r+1],complete:e[r+2]};else{const w=sn(n,Gt);a=sn(w.firestore,ur),u=w._query;const V=new xh(a);o={next:b=>{e[r]&&e[r](new cn(a,V,w,b))},error:e[r+1],complete:e[r+2]},jE(n._query)}const h=Ch(a);return RE(h,u,s,o)}function qh(n,e){const t=Ch(n);return SE(t,e)}function QE(n,e,t){const r=t.docs.get(e._key),s=new xh(n);return new Lt(n,s,e._key,r,new Wn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){vg(gn),un(new xt("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new ur(new Sg(r.getProvider("auth-internal")),new Cg(a,r.getProvider("app-check-internal")),Wg(a,s),a);return o={useFetchStreams:t,...o},u._setSettings(o),u}),"PUBLIC").setMultipleInstances(!0)),ft(lu,hu,e),ft(lu,hu,"esm2020")})();const YE={apiKey:"AIzaSyBrhhpGsDEIH46um9FS2j8uTleOwzPrHZ8",authDomain:"coda-tax.firebaseapp.com",projectId:"coda-tax",storageBucket:"coda-tax.firebasestorage.app",messagingSenderId:"788663710911",appId:"1:788663710911:web:33143712e512d6253c820a",measurementId:"G-LYGK290Y1Z"},jh=Su(YE),Bn=Ig(jh),jr=kE(jh);window.kodaEngine=(()=>{let n={isSubscribed:!1,currentUser:null,records:[],categories:[{id:"수입 합계",keywords:["애드센스","협찬","수입","입금","광고수익","도네","후원","정산"],type:"income",box:"수입"},{id:"식대",keywords:["식대","밥","회식","미팅","커피","편의점","식사"],type:"expense",box:"15"},{id:"여비교통비",keywords:["교통","차비","택시","버스","지하철","주유","기름","톨게이트","주차"],type:"expense",box:"15"},{id:"촬영소품",keywords:["소품","배경","의상","분장","액세서리","가발"],type:"expense",box:"11"},{id:"장비비",keywords:["장비","카메라","마이크","조명","렌즈","컴퓨터","PC","모니터","삼각대"],type:"expense",box:"22"},{id:"소프트웨어/구독",keywords:["구독","툴","프로그램","편집툴","클라우드","어도비","프리미어","라이선스","폰트"],type:"expense",box:"22"},{id:"외주/편집",keywords:["외주","편집","디자인","썸네일","컷편집","제작비"],type:"expense",box:"21"},{id:"통신비",keywords:["통신","인터넷","휴대폰","요금제"],type:"expense",box:"19"},{id:"소모품비",keywords:["소모품","사무용품","펜","종이","문구","건전지"],type:"expense",box:"22"},{id:"수선유지비",keywords:["수선","유지","수리","보수","수리비"],type:"expense",box:"22"},{id:"월세/임차료",keywords:["월세","임대료","임차료","관리비","스튜디오"],type:"expense",box:"13"},{id:"수도광열비",keywords:["수도","전기","가스","난방","냉난방"],type:"expense",box:"18"},{id:"보험료",keywords:["보험","국민연금","건강보험","자동차보험","산재"],type:"expense",box:"15"},{id:"세금과공과",keywords:["세금","면허세","재산세","공과금","범칙금"],type:"expense",box:"20"},{id:"지급수수료",keywords:["수수료","뱅킹수수료","결제수수료","이체수수료"],type:"expense",box:"21"},{id:"기타필요경비",keywords:[],type:"expense",box:"22"}],lastDetected:null,recognition:null,pendingCategory:null,pendingYear:null,isAuthInitialized:!1,portoneId:"imp33124838"};const e=b=>document.getElementById(b),t=b=>new Intl.NumberFormat("ko-KR").format(Math.floor(b)),r=(b,P="success")=>{let S=e("app-toast");S||(S=document.createElement("div"),S.id="app-toast",document.body.appendChild(S)),S.innerText=b,S.className=`toast-visible ${P}`,setTimeout(()=>S.className="",3e3)},s=b=>{window.location.hash=b==="/"?"#/":`#${b}`,o()},o=()=>{const b=window.location.hash||"#/",P=localStorage.getItem("yt_user_status")==="paid",S=e("user-type-overlay"),N=e("app-container");if(!(!S||!N)){if(!n.isAuthInitialized){console.log("Routing deferred - Auth not initialized");return}console.log("Routing Execution - Hash:",b,"User:",n.currentUser?n.currentUser.email:"null","isPaid:",P),b==="#/dashboard"||b.startsWith("#/dashboard")?n.currentUser?(S.style.display="none",N.style.display="flex",d()):P?(console.log("Showing dashboard with 'paid' flag but no user yet"),S.style.display="none",N.style.display="flex",d()):(alert("로그인이 필요합니다. (Routing: redirect to landing)"),console.log("Access denied - Redirecting to landing"),s("/")):n.currentUser?(console.log("Already logged in - Redirecting to dashboard"),s("/dashboard")):(S.style.display="flex",N.style.display="none")}},a=async()=>{alert("세무정석 엔진 시작 (v1020 - Force)"),um(Bn,P=>{if(console.log("onAuthStateChanged:",P?P.email:"no user"),n.currentUser=P,n.isAuthInitialized=!0,P){localStorage.setItem("yt_user_status","paid");const S=$E(yi(jr,"users",P.uid,"records"),zE("date","desc"));KE(S,N=>{console.log("Firestore Snapshot received, count:",N.docs.length),n.records=N.docs.map(M=>({id:M.id,...M.data()})),d()},N=>{console.error("Firestore Snapshot Error:",N)})}o()}),window.addEventListener("hashchange",o);const b=window.SpeechRecognition||window.webkitSpeechRecognition;b&&(n.recognition=new b,n.recognition.continuous=!1,n.recognition.interimResults=!0,n.recognition.lang="ko-KR",n.recognition.onresult=P=>{const S=e("voice-transcribed-text"),N=e("voice-result-box"),M=e("voice-status-text");let B="",Y="";for(let K=P.resultIndex;K<P.results.length;++K)P.results[K].isFinal?Y+=P.results[K][0].transcript:B+=P.results[K][0].transcript;S&&(S.innerText=Y||B),Y&&(n.lastDetected=h(Y),M&&(M.innerText="인식 성공! ✅"),N&&(N.style.display="block"))},n.recognition.onstart=()=>{console.log("Speech Recognition started");const P=e("voice-status-text");P&&(P.innerText="듣고 있습니다... (연결됨)")},n.recognition.onerror=P=>{console.error("Speech Recognition Error:",P.error);const S=e("voice-status-text");S&&(S.innerText="인식 오류: "+P.error),alert("음성 인식 오류: "+P.error+`
(마이크 권한 또는 브라우저 지원 확인 필요)`)},n.recognition.onend=()=>{console.log("Speech Recognition Ended")})},u=b=>{let P=0,S=b.replace(/[\s,]/g,"").replace(/원$/g,"");const N=S.match(/([\d\.]+)\s*억/);N&&(P+=parseFloat(N[1])*1e8);const M=S.match(/([\d\.]+)\s*천만/);M&&(P+=parseFloat(M[1])*1e7);const B=S.match(/([\d\.]+)\s*백만/);B&&(P+=parseFloat(B[1])*1e6);const Y=S.match(/([\d\.]+)\s*(?!천만|백만)만/);if(Y)P+=parseFloat(Y[1])*1e4;else if(!N&&!M&&!B){const K=S.match(/([\d\.]+)\s*만/);K&&(P+=parseFloat(K[1])*1e4)}if(P===0){const K={일:1,이:2,삼:3,사:4,오:5,육:6,칠:7,팔:8,구:9,십:10,백:100,천:1e3,만:1e4,억:1e8},le={십:10,백:100,천:1e3,만:1e4,억:1e8};let T=0,m=0,_=0;for(let I=0;I<S.length;I++){const E=S[I],v=K[E];v!==void 0&&(le[E]?v>=1e4?(T+=(m+(_||1))*v,m=0,_=0):(m+=(_||1)*v,_=0):_=v)}P=T+m+_}if(P===0){const K=S.replace(/[^0-9]/g,"");K&&(P=parseInt(K))}return P},h=b=>{const P=u(b);let S="기타필요경비";const N=b.toLowerCase();for(const Y of n.categories)if(Y.keywords.some(K=>N.includes(K))){S=Y.id;break}const M=new Date;return{date:`${M.getFullYear()}-${(M.getMonth()+1).toString().padStart(2,"0")}-${M.getDate().toString().padStart(2,"0")}`,type:S==="수입 합계"?"income":"expense",category:S,label:b.split(/[0-9]|만|원/)[0].trim()||(P===0?b:S),amount:P,status:"준비"}},d=()=>{if(n.currentUser){const S=e("user-status-indicator"),N=e("logged-in-user-id");S&&(S.style.display="block"),N&&(N.innerText=n.currentUser.email.split("@")[0])}else{const S=e("user-status-indicator");S&&(S.style.display="none")}const b=e("history-list-mvp");if(!b)return;const P=n.records.slice(0,10);P.length===0?b.innerHTML='<tr><td colspan="5" class="empty-row">기록이 없습니다.</td></tr>':b.innerHTML=P.map(S=>`
                <tr>
                    <td class="cell-date">${S.date.slice(5).replace("-","/")}</td>
                    <td class="cell-type ${S.type}">${S.type==="income"?"수입":"경비"}</td>
                    <td class="cell-cat">${S.label||S.category}</td>
                    <td class="cell-amt">${t(S.amount)}원</td>
                    <td style="text-align:right;"><button class="delete-btn" onclick="kodaEngine.deleteRecord('${S.id}')">✕</button></td>
                </tr>
            `).join("")};return{init:a,requestKakaoPay:()=>{const{IMP:b}=window;if(!b){alert("결제 모듈 로드 중입니다.");return}b.init(n.portoneId),b.request_pay({pg:"kakaopay.TC0ONETIME",pay_method:"card",merchant_uid:"merchant_"+new Date().getTime(),name:"세무정석 프리미엄 멤버십",amount:5900,buyer_email:"test@example.com",buyer_name:"테스트유저",buyer_tel:"010-1234-5678"},P=>{P.success?(e("payment-view-initial").style.display="none",e("payment-view-success").style.display="block"):alert("결제에 실패했습니다: "+P.error_msg)})},finalizeSignUp:async b=>{b&&b.preventDefault();const P=e("reg-id").value.trim(),S=e("reg-pw").value.trim(),N=e("reg-submit-btn");if(!P||!S){alert("아이디와 비밀번호를 모두 입력해주세요.");return}N&&(N.disabled=!0,N.innerText="결제 및 가입 처리 중...",N.style.opacity="0.7");try{const M=P.includes("@")?P:`${P}@coda-tax.com`;await im(Bn,M,S),e("payment-view-success").style.display="none",e("payment-view-final-success").style.display="block",localStorage.setItem("yt_user_status","paid")}catch(M){N&&(N.disabled=!1,N.innerText="시작하기",N.style.opacity="1"),console.error("Auth Error Detail:",M.code,M.message);let B="가입 오류가 발생했습니다. ";M.code==="auth/configuration-not-found"?B="Firebase 설정 오류: 'Email/Password' 인증을 활성화해 주세요.":M.code==="auth/email-already-in-use"?B="이미 존재하는 아이디입니다.":M.code==="auth/weak-password"?B="비밀번호는 6자리 이상이어야 합니다.":M.code==="auth/invalid-email"&&(B="아이디 형식이 올바르지 않습니다."),alert("⚠️ "+B)}},login:async b=>{b&&b.preventDefault();const P=e("login-id").value.trim(),S=e("login-pw").value.trim();if(!(!P||!S))try{const N=P.includes("@")?P:`${P}@coda-tax.com`,M=await om(Bn,N,S);alert("로그인 성공! (UID: "+M.user.uid.slice(0,5)+")"),n.currentUser=M.user,n.isAuthInitialized=!0,localStorage.setItem("yt_user_status","paid"),s("/dashboard")}catch(N){console.error("Login Error:",N),alert("로그인 오류: "+N.message)}},logout:async()=>{if(confirm("로그아웃 하시겠습니까?"))try{await lm(Bn),localStorage.removeItem("yt_user_status"),window.location.href=window.location.pathname+"#/",window.location.reload()}catch(b){console.error("Logout error:",b),alert("로그아웃 중 오류가 발생했습니다.")}},navigate:s,tryStartService:()=>{e("payment-view-initial").style.display="block",e("payment-view-success").style.display="none",e("payment-view-final-success").style.display="none",e("payment-modal").style.display="flex"},startVoiceRecord:()=>{console.log("startVoiceRecord clicked"),location.protocol!=="https:"&&location.hostname!=="localhost"&&alert(`⚠️ 음성 기록은 보안 연결(HTTPS)에서만 작동합니다.
현재: `+location.protocol);const b=e("voice-modal");if(!b){alert("오류: 음성 모달 요소를 찾을 수 없습니다.");return}e("voice-transcribed-text").innerText="",e("voice-result-box").style.display="none",e("voice-status-text").innerText="마이크 초기화 중...",b.style.display="flex";const P=window.SpeechRecognition||window.webkitSpeechRecognition;if(!n.recognition&&P&&(console.log("Lazy initializing SpeechRecognition..."),n.recognition=new P,n.recognition.continuous=!1,n.recognition.interimResults=!0,n.recognition.lang="ko-KR",n.recognition.onresult=S=>{let N="",M="";for(let B=S.resultIndex;B<S.results.length;++B)S.results[B].isFinal?M+=S.results[B][0].transcript:N+=S.results[B][0].transcript;e("voice-transcribed-text").innerText=M||N,M&&(n.lastDetected=h(M),e("voice-status-text").innerText="인식 성공! ✅",e("voice-result-box").style.display="block")},n.recognition.onerror=S=>alert("인식 오류: "+S.error)),n.recognition)try{console.log("Calling recognition.start()..."),n.recognition.start()}catch(S){console.error("Recognition Start Error:",S),S.name==="InvalidStateError"?(console.log("InvalidStateError: Attempting restart..."),n.recognition.stop(),setTimeout(()=>n.recognition.start(),100)):alert("마이크 시작 오류: "+S.message)}else alert("이 브라우저나 기기에서는 음성 인식을 지원하지 않습니다.")},confirmVoiceEntry:async()=>{if(!n.lastDetected){alert("인식된 내용이 없습니다.");return}if(!n.currentUser){alert("로그인 정보가 없습니다. 다시 로그인해 주세요."),s("/");return}const b=document.querySelector("#voice-result-box .btn-primary");b&&(b.disabled=!0,b.innerText="저장 중...");try{alert("디버그: Firestore 저장 시도 시작 (v1020)");const P={...n.lastDetected};e("voice-modal").style.display="none",n.lastDetected=null,b&&(b.disabled=!1,b.innerText="저장하기");const S=mu(yi(jr,"users",n.currentUser.uid,"records"),P),N=new Promise((B,Y)=>setTimeout(()=>Y(new Error("Firestore Timeout (10s)")),1e4)),M=await Promise.race([S,N]);console.log("Firestore Save Success - ID:",M.id),r("내역이 저장되었습니다! 🎉")}catch(P){console.error("Firestore Save Error/Timeout:",P),alert("저장 상태 확인 필요: "+P.message+`
(데이터가 이미 서버에 전송되었을 수 있습니다)`),r("저장 상태 불확실","error")}},cancelVoiceModal:()=>{n.lastDetected=null,e("voice-modal").style.display="none",e("voice-transcribed-text").innerText="",e("voice-result-box").style.display="none",e("voice-status-text").innerText="듣고 있습니다..."},clearVoiceTranscript:()=>{n.recognition&&n.recognition.start()},openAddModal:()=>e("edit-modal").style.display="flex",saveManualEntry:async b=>{if(b&&b.preventDefault(),!n.currentUser){alert("로그인 정보가 없습니다."),s("/");return}const P={date:e("edit-date").value||new Date().toISOString().split("T")[0],type:e("edit-type").value,category:e("edit-category").value,amount:parseInt(e("edit-amount").value)||0,status:"준비"};try{await mu(yi(jr,"users",n.currentUser.uid,"records"),P),alert("내역이 수동으로 저장되었습니다."),e("edit-modal").style.display="none"}catch(S){console.error("Manual Save Error:",S),alert("수동 저장 실패: "+S.message)}},deleteRecord:async b=>{confirm("정말 삭제하시겠습니까?")&&await GE(bh(jr,"users",n.currentUser.uid,"records",b))},showYearlyCategorySummary:()=>alert("상세 리포트 준비중입니다."),showPrevYearSummary:()=>alert("전년도 세무 리포트 준비중입니다."),openHometax:()=>window.open("https://www.hometax.go.kr","_blank"),loginWithGoogle:async()=>{try{const b=new He,P=await km(Bn,b);P.user&&(n.currentUser=P.user,n.isAuthInitialized=!0,localStorage.setItem("yt_user_status","paid"),console.log("Google Login success - Redirecting..."),s("/dashboard"))}catch(b){console.error("Google Login Error Details:",b);let P="구글 로그인 중 오류가 발생했습니다.";switch(b.code){case"auth/popup-blocked":P="⚠️ 브라우저 팝업이 차단되었습니다. 주소창 옆의 팝업 허용 버튼을 눌러주세요.";break;case"auth/popup-closed-by-user":return;case"auth/cancelled-popup-request":return;case"auth/unauthorized-domain":P="⚠️ 현재 도메인이 승인되지 않았습니다. Firebase 콘솔에서 도메인을 추가해주세요.";break;case"auth/network-request-failed":P="⚠️ 네트워크 연결이 불안정합니다. 인터넷 연결을 확인해주세요.";break;case"auth/internal-error":P="⚠️ 서버 내부 오류가 발생했습니다. 잠시 후 다시 시도해주세요.";break;default:P+=`
코드: ${b.code}
메시지: ${b.message}`}alert(P)}}}})();window.addEventListener("DOMContentLoaded",()=>{window.kodaEngine.init().catch(console.error)});
