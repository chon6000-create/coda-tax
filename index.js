 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cd(n,e){if(n.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const t={alg:"none",type:"JWT"},r=e||"demo-project",s=n.iat||0,o=n.sub||n.user_id;if(!o)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const a={iss:`https://securetoken.google.com/${r}`,aud:r,iat:s,exp:s+3600,auth_time:s,sub:o,user_id:o,firebase:{sign_in_provider:"custom",identities:{}},...n};return[Jr(JSON.stringify(t)),Jr(JSON.stringify(a)),""].join(".")}const Gn={};function kd(){const n={prod:[],emulator:[]};for(const e of Object.keys(Gn))Gn[e]?n.emulator.push(e):n.prod.push(e);return n}function Vd(n){let e=document.getElementById(n),t=!1;return e||(e=document.createElement("div"),e.setAttribute("id",n),t=!0),{created:t,element:e}}let xa=!1;function wu(n,e){if(typeof window>"u"||typeof document>"u"||!mn(window.location.host)||Gn[n]===e||Gn[n]||xa)return;Gn[n]=e;function t(_){return`__firebase__banner__${_}`}const r="__firebase__banner",o=kd().prod.length>0;function a(){const _=document.getElementById(r);_&&_.remove()}function u(_){_.style.display="flex",_.style.background="#7faaf0",_.style.position="fixed",_.style.bottom="5px",_.style.left="5px",_.style.padding=".5em",_.style.borderRadius="5px",_.style.alignItems="center"}function h(_,S){_.setAttribute("width","24"),_.setAttribute("id",S),_.setAttribute("height","24"),_.setAttribute("viewBox","0 0 24 24"),_.setAttribute("fill","none"),_.style.marginLeft="-6px"}function d(){const _=document.createElement("span");return _.style.cursor="pointer",_.style.marginLeft="16px",_.style.fontSize="24px",_.innerHTML=" &times;",_.onclick=()=>{xa=!0,a()},_}function p(_,S){_.setAttribute("id",S),_.innerText="Learn more",_.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",_.setAttribute("target","__blank"),_.style.paddingLeft="5px",_.style.textDecoration="underline"}function E(){const _=Vd(r),S=t("text"),P=document.getElementById(S)||document.createElement("span"),k=t("learnmore"),V=document.getElementById(k)||document.createElement("a"),x=t("preprendIcon"),M=document.getElementById(x)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(_.created){const $=_.element;u($),p(V,k);const fe=d();h(M,x),$.append(M,P,V,fe),document.body.appendChild($)}o?(P.innerText="Preview backend disconnected.",M.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
...
</defs>`,P.innerText="Preview backend running in this workspace."),P.setAttribute("id",S)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",E):E()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yf=1024,Jf=30;class Xf{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new ep(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,t;try{const s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=Wa();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)==null?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(a=>a.date===o))return;if(this._heartbeatsCache.heartbeats.push({date:o,agent:s}),this._heartbeatsCache.heartbeats.length>Jf){const a=tp(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){Ke.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=Wa(),{heartbeatsToSend:r,unsentEntries:s}=Zf(this._heartbeatsCache.heartbeats),o=Jr(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=t,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(t){return Ke.warn(t),""}}}function Wa(){return new Date().toISOString().substring(0,10)}function Zf(n,e=Yf){const t=[];let r=n.slice();for(const s of n){const o=t.find(a=>a.agent===s.agent);if(o){if(o.dates.push(s.date),Ha(t)>e){o.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),Ha(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class ep{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Ud()?Bd().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await Qf(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return za(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const r=await this.read();return za(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??r.lastSentHeartbeatDate,heartbeats:[...r.heartbeats,...e.heartbeats]})}else return}}function Ha(n){return Jr(JSON.stringify({version:2,heartbeats:n})).length}function tp(n){if(n.length===0)return-1;let e=0,t=n[0].date;for(let r=1;r<n.length;r++)n[r].date<t&&(t=n[r].date,e=r);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xa(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Uu(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Mu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(qu(e))return"Blackberry";if(ju(e))return"Webos";if(xu(e))return"Safari";if((e.includes("chrome/")||Fu(e))&&!e.includes("edge/"))return"Chrome";if(Bu(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Mu(n=Te()){return/firefox\//i.test(n)}function xu(n=Te()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Fu(n=Te()){return/crios\//i.test(n)}function Uu(n=Te()){return/iemobile/i.test(n)}function Bu(n=Te()){return/android/i.test(n)}function qu(n=Te()){return/blackberry/i.test(n)}function ju(n=Te()){return/webos/i.test(n)}function Yi(n=Te()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Sp(n=Te()){var e;return Yi(n)&&!!((e=window.navigator)!=null&&e.standalone)}function Pp(){return xd()&&document.documentMode===10}function $u(n=Te()){return Yi(n)||Bu(n)||ju(n)||qu(n)||/windows phone/i.test(n)||Uu(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qp(n,e){const t=Wi(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),o=t.getOptions();if(Ot(o,e??{}))return s;ke(s,"already-initialized")}return t.initialize({options:e})}function jp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Ge);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function $p(n,e,t){const r=qt(n);F(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,o=Gu(e),{host:a,port:u}=zp(e),h=u===null?"":`:${u}`,d={url:`${o}//${a}${h}/`},p=Object.freeze({host:a,port:u,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){F(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),F(Ot(d,r.config.emulator)&&Ot(p,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=d,r.emulatorConfig=p,r.settings.appVerificationDisabledForTesting=!0,mn(a)?(Iu(`${o}//${a}${h}`),wu("Auth",!0)):Wp()}function Gu(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function zp(n){const e=Gu(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const o=s[1];return{host:o,port:nc(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:nc(a)}}}function nc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Wp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ji{constructor(e,t){this.providerId=e,this.signInMethod=t}toJSON(){return He("not implemented")}_getIdTokenResponse(e){return He("not implemented")}_linkToIdToken(e,t){return He("not implemented")}_getReauthenticationResolver(e){return He("not implemented")}}async function Hp(n,e){return wt(n,"POST","/v1/accounts:signUp",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hm=new dr(5e3,15e3),Gm="__/auth/iframe",Km="emulator/auth/iframe",Qm={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ym=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Jm(n){const e=n.config;F(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Ki(e,Km):`https://${n.config.authDomain}/${Gm}`,r={apiKey:e.apiKey,appName:n.name,v:gn},s=Ym.get(n.config.apiHost);s&&(r.eid=s);const o=n._getFrameworks();return o.length&&(r.fw=o.join(",")),`${t}?${hr(r).slice(1)}`}async function Xm(n){const e=await Wm(n),t=Ue().gapi;return F(t,n,"internal-error"),e.open({where:document.body,url:Jm(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Qm,dontclear:!0},r=>new Promise(async(s,o)=>{await r.restyle({setHideOnLeave:!1});const a=Ne(n,"network-request-failed"),u=Ue().setTimeout(()=>{o(a)},Hm.get());function h(){Ue().clearTimeout(u),s(r)}r.ping(h).then(h,()=>{o(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`}),c}function ei(i,c,l){e:{for(f in l){var f=!1;break e}f=!0}f||(l=_a(l),typeof i=="string"?l!=null&&bn(l):J(i,c,l))}function ee(i){ge.call(this),this.headers=new Map,this.L=i||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}E(ee,ge);var md=/^https?$/i,gd=["POST","PUT"];n=ee.prototype,n.Fa=function(i){this.H=i},n.ea=function(i,c,l,f){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);c=c?c.toUpperCase():"GET",this.D=i,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():Xo.g(),this.g.onreadystatechange=_(d(this.Ca,this));try{this.B=!0,this.g.open(c,String(i),!0),this.B=!1}catch(R){ya(this,R);return}if(i=l||"",l=new Map(this.headers),f)if(Object.getPrototypeOf(f)===Object.prototype)for(var v in f)l.set(v,f[v]);else if(typeof f.keys=="function"&&typeof f.get=="function")for(const R of f.keys())l.set(R,f.get(R));else throw Error("Unknown input type for opt_headers: "+String(f));f=Array.from(l.keys()).find(R=>R.toLowerCase()=="content-type"),v=a.FormData&&i instanceof a.FormData,!(Array.prototype.indexOf.call(gd,c,void 0)>=0)||f||v||l.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,D]of l)this.g.setRequestHeader(R,D);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(i),this.v=!1}catch(R){ya(this,R)}};function ya(i,c){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=c,i.o=5,Ea(i),Cr(i)}function Ea(i){i.A||(i.A=!0,we(i,"complete"),we(i,"error"))}n.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=i||7,we(this,"complete"),we(this,"abort"),Cr(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Cr(this,!0)),ee.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?Ta(this):this.Xa())},n.Xa=function(){Ta(this)};function Ta(i){if(i.h&&typeof o<"u"){if(i.v&&nt(i)==4)setTimeout(i.Ca.bind(i),0);else if(we(i,"readystatechange"),nt(i)==4){i.h=!1;try{const R=i.ca();e:switch(R){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break e;default:c=!1}var l;if(!(l=c)){var f;if(f=R===0){let D=String(i.D).match(ua)[1]||null;!D&&a.self&&a.self.location&&(D=a.self.location.protocol.slice(0,-1)),f=!md.test(D?D.toLowerCase():"")}l=f}if(l)we(i,"complete"),we(i,"success");else{i.o=6;try{var v=nt(i)>2?i.g.statusText:""}catch{v=""}i.l=v+" ["+i.ca()+"]",Ea(i)}}finally{Cr(i)}}}}function Cr(i,c){if(i.g){i.m&&(clearTimeout(i.m),i.m=null);const l=i.g;i.g=null,c||we(i,"ready");try{l.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function nt(i){return i.g?i.g.readyState:0}n.ca=function(){try{return nt(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(i){if(this.g){var c=this.g.responseText;return i&&c.indexOf(i)==0&&(c=c.substring(i.length)),Qh(c)}};function Ia(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.F){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function _d(i){const c={};i=(i.g&&nt(i)>=2&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let f=0;f<i.length;f++){if(g(i[f]))continue;var l=td(i[f]);const v=l[0];if(l=l[1],typeof l!="string")continue;l=l.trim();const R=c[v]||[];c[v]=R,R.push(l)}$h(c,function(f){return f.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function xn(i,c,l){return l&&l.internalChannelParams&&l.internalChannelParams[i]||c}function wa(i){this.za=0,this.i=[],this.j=new Pn,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=xn("failFast",!1,i),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=xn("baseRetryDelayMs",5e3,i),this.Za=xn("retryDelaySeedMs",1e4,i),this.Ta=xn("forwardChannelMaxRetries",2,i),this.va=xn("forwardChannelRequestTimeoutMs",2e4,i),this.ma=i&&i.xmlHttpFactory||void 0,this.Ua=i&&i.Rb||void 0,this.Aa=i&&i.useFetchStreams||!1,this.O=void 0,this.L=i&&i.supportsCrossDomainXhr||!1,this.M="",this.h=new sa(i&&i.concurrentRequestLimit),this.Ba=new pd,this.S=i&&i.fastHandshake||!1,this.R=i&&i.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=i&&i.Pb||!1,i&&i.ua&&this.j.ua(),i&&i.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&i&&i.detectBufferingProxy||!1,this.ia=void 0,i&&i.longPollingTimeout&&i.longPollingTimeout>0&&(this.ia=i.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=wa.prototype,n.ka=8,n.I=1,n.connect=function(i,c,l,f){ve(0),this.W=i,this.H=c||{},l&&f!==void 0&&(this.H.OSID=l,this.H.OAID=f),this.F=this.X,this.J=Va(this,null,this.W),Vr(this)};function ti(i){if(va(i),i.I==3){var c=i.V++,l=Me(i.J);if(J(l,"SID",i.M),J(l,"RID",c),J(l,"TYPE","terminate"),Fn(i,l),c=new Ze(i,i.j,c),c.M=2,c.A=Pr(Me(l)),l=!1,a.navigator&&a.navigator.sendBeacon)try{l=a.navigator.sendBeacon(c.A.toString(),"")}catch{}!l&&a.Image&&(new Image().src=c.A,l=!0),l||(c.g=Da(c.j,null),c.g.ea(c.A)),c.F=Date.now(),Sr(c)}ka(i)}function kr(i){i.g&&(ri(i),i.g.cancel(),i.g=null)}function va(i){kr(i),i.v&&(a.clearTimeout(i.v),i.v=null),Dr(i),i.h.cancel(),i.m&&(typeof i.m=="number"&&a.clearTimeout(i.m),i.m=null)}function Vr(i){if(!ia(i.h)&&!i.m){i.m=!0;var c=i.Ea;pe||m(),me||(pe(),me=!0),I.add(c,i),i.D=0}}function yd(i,c){return oa(i.h)>=i.h.j-(i.m?1:0)?!1:i.m?(i.i=c.G.concat(i.i),!0):i.I==1||i.I==2||i.D>=(i.Sa?0:i.Ta)?!1:(i.m=Sn(d(i.Ea,i,c),Ca(i,i.D)),i.D++,!0)}n.Ea=function(i){if(this.m)if(this.m=null,this.I==1){if(!i){this.V=Math.floor(Math.random()*1e5),i=this.V++;const v=new Ze(this,this.j,i);let R=this.o;if(this.U&&(R?(R=Lo(R),xo(R,this.U)):R=this.U),this.u!==null||this.R||(v.J=R,R=null),this.S)e:{for(var c=0,l=0;l<this.i.length;l++){t:{var f=this.i[l];if("__data__"in f.map&&(f=f.map.__data__,typeof f=="string")){f=f.length;break t}f=void 0}if(f===void 0)break;if(c+=f,c>4096){c=l;break e}if(c===4096||l===this.i.length-1){c=l+1;break e}}c=1e3}else c=1e3;c=Ra(this,v,c),l=Me(this.J),J(l,"RID",i),J(l,"CVER",22),this.G&&J(l,"X-HTTP-Session-Id",this.G),Fn(this,l),R&&(this.R?c="headers="+bn(_a(R))+"&"+c:this.u&&ei(l,this.u,R)),Js(this.h,v),this.Ra&&J(l,"TYPE","init"),this.S?(J(l,"$req",c),J(l,"SID","null"),v.U=!0,Gs(v,l,null)):Gs(v,l,c),this.I=2}}else this.I==3&&(i?Aa(this,i):this.i.length==0||ia(this.h)||Aa(this))};function Aa(i,c){var l;c?l=c.l:l=i.V++;const f=Me(i.J);J(f,"SID",i.M),J(f,"RID",l),J(f,"AID",i.K),Fn(i,f),i.u&&i.o&&ei(f,i.u,i.o),l=new Ze(i,i.j,l,i.D+1),i.u===null&&(l.J=i.o),c&&(i.i=c.G.concat(i.i)),c=Ra(i,l,1e3),l.H=Math.round(i.va*.5)+Math.round(i.va*.5*Math.random()),Js(i.h,l),Gs(l,f,c)}function Fn(i,c){i.H&&Ir(i.H,function(l,f){J(c,f,l)}),i.l&&Ir({},function(l,f){J(c,f,l)})}function Ra(i,c,l){l=Math.min(i.i.length,l);const f=i.l?d(i.l.Ka,i.l,i):null;e:{var v=i.i;let j=-1;for(;;){const ie=["count="+l];j==-1?l>0?(j=v[0].g,ie.push("ofs="+j)):j=0:ie.push("ofs="+j);let Q=!0;for(let ce=0;ce<l;ce++){var R=v[ce].g;const xe=v[ce].map;if(R-=j,R<0)j=Math.max(0,v[ce].g-100),Q=!1;else try{R="req"+R+"_"||"";try{var D=xe instanceof Map?xe:Object.entries(xe);for(const[bt,rt]of D){let st=rt;u(rt)&&(st=js(rt)),ie.push(R+bt+"="+encodeURIComponent(st))}}catch(bt){throw ie.push(R+"type="+encodeURIComponent("_badmap")),bt}}catch{f&&f(xe)}}if(Q){D=ie.join("&");break e}}D=void 0}return i=i.i.splice(0,l),c.G=i,D}function Sa(i){if(!i.g&&!i.v){i.Y=1;var c=i.Da;pe||m(),me||(pe(),me=!0),I.add(c,i),i.A=0}}function ni(i){return i.g||i.v||i.A>=3?!1:(i.Y++,i.v=Sn(d(i.Da,i),Ca(i,i.A)),i.A++,!0)}n.Da=function(){if(this.v=null,Pa(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var i=4*this.T;this.j.info("BP detection timer enabled: "+i),this.B=Sn(d(this.Wa,this),i)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,ve(10),kr(this),Pa(this))};function ri(i){i.B!=null&&(a.clearTimeout(i.B),i.B=null)}function Pa(i){i.g=new Ze(i,i.j,"rpc",i.Y),i.u===null&&(i.g.J=i.o),i.g.P=0;var c=Me(i.na);J(c,"RID","rpc"),J(c,"SID",i.M),J(c,"AID",i.K),J(c,"CI",i.F?"0":"1"),!i.F&&i.ia&&J(c,"TO",i.ia),J(c,"TYPE","xmlhttp"),Fn(i,c),i.u&&i.o&&ei(c,i.u,i.o),i.O&&(i.g.H=i.O);var l=i.g;i=i.ba,l.M=1,l.A=Pr(Me(c)),l.u=null,l.R=!0,ta(l,i)}n.Va=function(){this.C!=null&&(this.C=null,kr(this),ni(this),ve(19))};function Dr(i){i.C!=null&&(a.clearTimeout(i.C),i.C=null)}function ba(i,c){var l=null;if(i.g==c){Dr(i),ri(i),i.g=null;var f=2}else if(Ys(i.h,c))l=c.G,aa(i.h,c),f=1;else return;if(i.I!=0){if(c.o)if(f==1){l=c.u?c.u.length:0,c=Date.now()-c.F;var v=i.D;f=Ar(),we(f,new Yo(f,l)),Vr(i)}else Sa(i);else if(v=c.m,v==3||v==0&&c.X>0||!(f==1&&yd(i,c)||f==2&&ni(i)))switch(l&&l.length>0&&(c=i.h,c.i=c.i.concat(l)),v){case 1:Pt(i,5);break;case 4:Pt(i,10);break;case 3:Pt(i,6);break;default:Pt(i,2)}}}function Ca(i,c){let l=i.Qa+Math.floor(Math.random()*i.Za);return i.isActive()||(l*=2),l*c}function Pt(i,c){if(i.j.info("Error code "+c),c==2){var l=d(i.bb,i),f=i.Ua;const v=!f;f=new et(f||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||kn(f,"https"),Pr(f),v?dd(f.toString(),l):fd(f.toString(),l)}else ve(2);i.I=0,i.l&&i.l.pa(c),ka(i),va(i)}n.bb=function(i){i?(this.j.info("Successfully pinged google.com"),ve(2)):(this.j.info("Failed to ping google.com"),ve(1))};function ka(i){if(i.I=0,i.ja=[],i.l){const c=ca(i.h);(c.length!=0||i.i.length!=0)&&(P(i.ja,c),P(i.ja,i.i),i.h.i.length=0,S(i.i),i.i.length=0),i.l.oa()}}function Va(i,c,l){var f=l instanceof et?Me(l):new et(l);if(f.g!="")c&&(f.g=c+"."+f.g),Vn(f,f.u);else{var v=a.location;f=v.protocol,c=c?c+"."+v.hostname:v.hostname,v=+v.port;const R=new et(null);f&&kn(R,f),c&&(R.g=c),v&&Vn(R,v),l&&(R.h=l),f=R}return l=i.G,c=i.wa,l&&c&&J(f,l,c),J(f,"VER",i.ka),Fn(i,f),f}function Da(i,c,l){if(c&&!i.L)throw Error("Can't create secondary domain capable XhrIo object.");return c=i.Aa&&!i.ma?new ee(new Zs({ab:l})):new ee(i.ma),c.Fa(i.L),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Na(){}n=Na.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function Nr(){}Nr.prototype.g=function(i,c){return new Se(i,c)};function Se(i,c){ge.call(this),this.g=new wa(c),this.l=i,this.h=c&&c.messageUrlParams||null,i=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(i?i["X-WebChannel-Content-Type"]=c.messageContentType:i={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.sa&&(i?i["X-WebChannel-Client-Profile"]=c.sa:i={"X-WebChannel-Client-Profile":c.sa}),this.g.U=i,(i=c&&c.Qb)&&!g(i)&&(this.g.u=i),this.A=c&&c.supportsCrossDomainXhr||!1,this.v=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!g(c)&&(this.g.G=c,i=this.h,i!==null&&c in i&&(i=this.h,c in i&&delete i[c])),this.j=new Qt(this)}E(Se,ge),Se.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},Se.prototype.close=function(){ti(this.g)},Se.prototype.o=function(i){var c=this.g;if(typeof i=="string"){var l={};l.__data__=i,i=l}else this.v&&(l={},l.__data__=js(i),i=l);c.i.push(new sd(c.Ya++,i)),c.I==3&&Vr(c)},Se.prototype.N=function(){this.g.l=null,delete this.j,ti(this.g),delete this.g,Se.Z.N.call(this)};function Oa(i){$s.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var c=i.__sm__;if(c){e:{for(const l in c){i=l;break e}i=void 0}(this.i=i)&&(i=this.i,c=c!==null&&i in c?c[i]:void 0),this.data=c}else this.data=i}E(Oa,$s);function La(){zs.call(this),this.status=1}E(La,zs);function Qt(i){this.g=i}E(Qt,Na),Qt.prototype.ra=function(){we(this.g,"a")},Qt.prototype.qa=function(i){we(this.g,new Oa(i))},Qt.prototype.pa=function(i){we(this.g,new La)},Qt.prototype.oa=function(){we(this.g,"b")},Nr.prototype.createWebChannel=Nr.prototype.g,Se.prototype.send=Se.prototype.o,Se.prototype.open=Se.prototype.m,Se.prototype.close=Se.prototype.close,dl=function(){return new Nr},hl=function(){return Ar()},ll=At,Si={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Rr.NO_ERROR=0,Rr.TIMEOUT=8,Rr.HTTP_ERROR=6,Wr=Rr,Jo.COMPLETE="complete",ul=Jo,Ho.EventType=An,An.OPEN="a",An.CLOSE="b",An.ERROR="c",An.MESSAGE="d",ge.prototype.listen=ge.prototype.J,jn=Ho,ee.prototype.listenOnce=ee.prototype.K,ee.prototype.getLastError=ee.prototype.Ha,ee.prototype.getLastErrorCode=ee.prototype.ya,ee.prototype.getStatus=ee.prototype.ca,ee.prototype.getResponseJson=ee.prototype.La,ee.prototype.getResponseText=ee.prototype.la,ee.prototype.send=ee.prototype.ea,ee.prototype.setWithCredentials=ee.prototype.Fa,cl=ee}).apply(typeof Mr<"u"?Mr:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xt=new $i("@firebase/firestore");function Yt(){return xt.logLevel}function O(n,...e){if(xt.logLevel<=z.DEBUG){const t=e.map(no);xt.debug(`Firestore (${yn}): ${n}`,...t)}}function Ye(n,...e){if(xt.logLevel<=z.ERROR){const t=e.map(no);xt.error(`Firestore (${yn}): ${n}`,...t)}}function Ft(n,...e){if(xt.logLevel<=z.WARN){const t=e.map(no);xt.warn(`Firestore (${yn}): ${n}`,...t)}}function no(n){if(typeof n=="string")return n;try{return(function(t){return JSON.stringify(t)})(n)}catch{return n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ro{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(4.129032258064516);let r="";for(;r.length<20;){const s=Pg(40);for(let o=0;o<s.length;++o)r.length<20&&s[o]<t&&(r+=e.charAt(s[o]%62))}return r}}function W(n,e){return n<e?-1:n>e?1:0}function Pi(n,e){const t=Math.min(n.length,e.length);for(let r=0;r<t;r++){const s=n.charAt(r),o=e.charAt(r);if(s!==o)return di(s)===di(o)?W(s,o):di(s)?1:-1}return W(n.length,e.length)}const bg=55296,Cg=57343;function di(n){const e=n.charCodeAt(0);return e>=bg&&e<=Cg}function ln(n,e,t){return n.length===e.length&&n.every(((r,s)=>t(r,e[s])))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yc=-62135596800,Ec=1e6;class X{static now(){return X.fromMillis(Date.now())}static fromDate(e){return X.fromMillis(e.getTime())}static fromMillis(e){const t=Math.floor(e/1e3),r=Math.floor((e-1e3*t)*Ec);return new X(t,r)}constructor(e,t){if(this.seconds=e,this.nanoseconds=t,t<0)throw new N(b.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(t>=1e9)throw new N(b.INVALID_ARGUMENT,"Timestamp nanoseconds out of range: "+t);if(e<yc)throw new N(b.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e);if(e>=253402300800)throw new N(b.INVALID_ARGUMENT,"Timestamp seconds out of range: "+e)}toDate(){return new Date(this.toMillis())}toMillis(){return 1e3*this.seconds+this.nanoseconds/Ec}_compareTo(e){return this.seconds===e.seconds?W(this.nanoseconds,e.nanoseconds):W(this.seconds,e.seconds)}isEqual(e){return e.seconds===this.seconds&&e.nanoseconds===this.nanoseconds}toString(){return"Timestamp(seconds="+this.seconds+", nanoseconds="+this.nanoseconds+")"}toJSON(){return{type:X._jsonSchemaVersion,seconds:this.seconds,nanoseconds:this.nanoseconds}}static fromJSON(e){if(mr(e,X._jsonSchema))return new X(e.seconds,e.nanoseconds)}valueOf(){const e=this.seconds-yc;return String(e).padStart(12,"0")+"."+String(this.nanoseconds).padStart(9,"0")}}X._jsonSchemaVersion="firestore/timestamp/1.0",X._jsonSchema={type:se("string",X._jsonSchemaVersion),seconds:se("number"),nanoseconds:se("number")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function En(n){if(n.code!==b.FAILED_PRECONDITION||n.message!==Lg)throw n;O("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class de{constructor(e){this.binaryString=e}static fromBase64String(e){const t=(function(s){try{return atob(s)}catch(o){throw typeof DOMException<"u"&&o instanceof DOMException?new El("Invalid base64 string: "+o):o}})(e);return new de(t)}static fromUint8Array(e){const t=(function(s){let o="";for(let a=0;a<s.length;++a)o+=String.fromCharCode(s[a]);return o})(e);return new de(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(t){return btoa(t)})(this.binaryString)}toUint8Array(){return(function(t){const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return W(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}de.EMPTY_BYTE_STRING=new de("");const qg=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function _t(n){if(K(!!n,39018),typeof n=="string"){let e=0;const t=qg.exec(n);if(K(!!t,46558,{timestamp:n}),t[1]){let s=t[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:te(n.seconds),nanos:te(n.nanos)}}function te(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function yt(n){return typeof n=="string"?de.fromBase64String(n):de.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qr{constructor(e,t,r,s){this.Se=e,this.removedTargetIds=t,this.key=r,this.De=s}}class Gl{constructor(e,t){this.targetId=e,this.Ce=t}}class Kl{constructor(e,t,r=de.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class Fc{constructor(){this.ve=0,this.Fe=Uc(),this.Me=de.EMPTY_BYTE_STRING,this.xe=!1,this.Oe=!0}get current(){return this.xe}get resumeToken(){return this.Me}get Ne(){return this.ve!==0}get Be(){return this.Oe}Le(e){e.approximateByteSize()>0&&(this.Oe=!0,this.Me=e)}ke(){let e=H(),t=H(),r=H();return this.Fe.forEach(((s,o)=>{switch(o){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:U(38017,{changeType:o})}})),new _r(this.Me,this.xe,e,t,r)}Ke(){this.Oe=!1,this.Fe=Uc()}qe(e,t){this.Oe=!0,this.Fe=this.Fe.insert(e,t)}Ue(e){this.Oe=!0,this.Fe=this.Fe.remove(e)}$e(){this.ve+=1}We(){this.ve-=1,K(this.ve>=0,3241,{ve:this.ve})}Qe(){this.Oe=!0,this.xe=!0}}class b_{constructor(e){this.Ge=e,this.ze=new Map,this.je=Je(),this.He=Ur(),this.Je=Ur(),this.Ze=new Z(W)}Xe(e){for(const t of e.Se)e.De&&e.De.isFoundDocument()?this.Ye(t,e.De):this.et(t,e.key,e.De);for(const t of e.removedTargetIds)this.et(t,e.key,e.De)}tt(e){this.forEachTarget(e,(t=>{const r=this.nt(t);switch(e.state){case 0:this.rt(t)&&r.Le(e.resumeToken);break;case 1:r.We(),r.Ne||r.Ke(),r.Le(e.resumeToken);break;case 2:r.We(),r.Ne||this.removeTarget(t);break;case 3:this.rt(t)&&(r.Qe(),r.Le(e.resumeToken));break;case 4:this.rt(t)&&(this.it(t),r.Le(e.resumeToken));break;default:U(56790,{state:e.state})}}))}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.ze.forEach(((r,s)=>{this.rt(s)&&t(s)}))}st(e){const t=e.targetId,r=e.Ce.count,s=this.ot(t);if(s){const o=s.target;if(Vi(o))if(r===0){const a=new L(o.path);this.et(t,a,Ee.newNoDocument(a,B.min()))}else K(r===1,20013,{expectedCount:r});else{const a=this._t(t);if(a!==r){const u=this.ut(e),h=u?this.ct(u,e,a):1;if(h!==0){this.it(t);const d=h===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ze=this.Ze.insert(t,d)}}}}}ut(e){const t=e.Ce.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:o=0}=t;let a,u;try{a=yt(r).toUint8Array()}catch(h){if(h instanceof El)return Ft("Decoding the base64 bloom filter in existence filter failed ("+h.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw h}try{u=new po(a,s,o)}catch(h){return Ft(h instanceof zn?"BloomFilter error: ":"Applying bloom filter failed: ",h),null}return u.ge===0?null:u}ct(e,t,r){return t.Ce.count===r-this.Pt(e,t.targetId)?0:2}Pt(e,t){const r=this.Ge.getRemoteKeysForTarget(t);let s=0;return r.forEach((o=>{const a=this.Ge.ht(),u=`projects/${a.projectId}/databases/${a.database}/documents/${o.path.canonicalString()}`;e.mightContain(u)||(this.et(t,o,null),s++)})),s}Tt(e){const t=new Map;this.ze.forEach(((o,a)=>{const u=this.ot(a);if(u){if(o.current&&Vi(u.target)){const h=new L(u.target.path);this.It(h).has(a)||this.Et(a,h)||this.et(a,h,Ee.newNoDocument(h,e))}o.Be&&(t.set(a,o.ke()),o.Ke())}}));let r=H();this.Je.forEach(((o,a)=>{let u=!0;a.forEachWhile((h=>{const d=this.ot(h);return!d||d.purpose==="TargetPurposeLimboResolution"||(u=!1,!1)})),u&&(r=r.add(o))})),this.je.forEach(((o,a)=>a.setReadTime(e)));const s=new Cs(e,t,this.Ze,this.je,r);return this.je=Je(),this.He=Ur(),this.Je=Ur(),this.Ze=new Z(W),s}Ye(e,t){if(!this.rt(e))return;const r=this.Et(e,t.key)?2:0;this.nt(e).qe(t.key,r),this.je=this.je.insert(t.key,t),this.He=this.He.insert(t.key,this.It(t.key).add(e)),this.Je=this.Je.insert(t.key,this.Rt(t.key).add(e))}et(e,t,r){if(!this.rt(e))return;const s=this.nt(e);this.Et(e,t)?s.qe(t,1):s.Ue(t),this.Je=this.Je.insert(t,this.Rt(t).delete(e)),this.Je=this.Je.insert(t,this.Rt(t).add(e)),r&&(this.je=this.je.insert(t,r))}removeTarget(e){this.ze.delete(e)}_t(e){const t=this.nt(e).ke();return this.Ge.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}$e(e){this.nt(e).$e()}nt(e){let t=this.ze.get(e);return t||(t=new Fc,this.ze.set(e,t)),t}Rt(e){let t=this.Je.get(e);return t||(t=new ae(W),this.Je=this.Je.insert(e,t)),t}It(e){let t=this.He.get(e);return t||(t=new ae(W),this.He=this.He.insert(e,t)),t}rt(e){const t=this.ot(e)!==null;return t||O("WatchChangeAggregator","Detected inactive target",e),t}ot(e){const t=this.ze.get(e);return t&&t.Ne?null:this.Ge.At(e)}it(e){this.ze.set(e,new Fc),this.Ge.getRemoteKeysForTarget(e).forEach((t=>{this.et(e,t,null)}))}Et(e,t){return this.Ge.getRemoteKeysForTarget(e).has(t)}}function Ur(){return new Z(L.comparator)}function Uc(){return new Z(L.comparator)}const C_={asc:"ASCENDING",desc:"DESCENDING"},k_={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},V_={and:"AND",or:"OR"};class D_{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Oi(n,e){return n.useProto3Json||vs(e)?e:{value:e}}function hs(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Ql(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function N_(n,e){return hs(n,e.toTimestamp())}function je(n){return K(!!n,49232),B.fromTimestamp((function(t){const r=_t(t);return new X(r.seconds,r.nanos)})(n))}function mo(n,e){return Li(n,e).canonicalString()}function Li(n,e){const t=(function(s){return new Y(["projects",s.projectId,"databases",s.database])})(n).child("documents");return e===void 0?t:t.child(e)}function Yl(n){const e=Y.fromString(n);return K(th(e),10190,{key:e.toString()}),e}function Mi(n,e){return mo(n.databaseId,e.path)}function fi(n,e){const t=Yl(e);if(t.get(1)!==n.databaseId.projectId)throw new N(b.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new N(b.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new L(Xl(t))}function Jl(n,e){return mo(n.databaseId,e)}function O_(n){const e=Yl(n);return e.length===4?Y.emptyPath():Xl(e)}function xi(n){return new Y(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function Xl(n){return K(n.length>4&&n.get(4)==="documents",29091,{key:n.toString()}),n.popFirst(5)}function Bc(n,e,t){return{name:Mi(n,e),fields:t.value.mapValue.fields}}function L_(n,e){let t;if("targetChange"in e){e.targetChange;const r=(function(d){return d==="NO_CHANGE"?0:d==="ADD"?1:d==="REMOVE"?2:d==="CURRENT"?3:d==="RESET"?4:U(39313,{state:d})})(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],o=(function(d,p){return d.useProto3Json?(K(p===void 0||typeof p=="string",58123),de.fromBase64String(p||"")):(K(p===void 0||p instanceof Buffer||p instanceof Uint8Array,16193),de.fromUint8Array(p||new Uint8Array))})(n,e.targetChange.resumeToken),a=e.targetChange.cause,u=a&&(function(d){const p=d.code===void 0?b.UNKNOWN:Hl(d.code);return new N(p,d.message||"")})(a);t=new Kl(r,s,o,u||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=fi(n,r.document.name),o=je(r.document.updateTime),a=r.document.createTime?je(r.document.createTime):B.min(),u=new be({mapValue:{fields:r.document.fields}}),h=Ee.newFoundDocument(s,o,a,u),d=r.targetIds||[],p=r.removedTargetIds||[];t=new Qr(d,p,h.key,h)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=fi(n,r.document),o=r.readTime?je(r.readTime):B.min(),a=Ee.newNoDocument(s,o),u=r.removedTargetIds||[];t=new Qr([],u,a.key,a)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=fi(n,r.document),o=r.removedTargetIds||[];t=new Qr([],o,s,null)}else{if(!("filter"in e))return U(11601,{Vt:e});{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:o}=r,a=new A_(s,o),u=r.targetId;t=new Gl(u,a)}}return t}function M_(n,e){let t;if(e instanceof gr)t={update:Bc(n,e.key,e.value)};else if(e instanceof ho)t={delete:Mi(n,e.key)};else if(e instanceof zt)t={update:Bc(n,e.key,e.data),updateMask:W_(e.fieldMask)};else{if(!(e instanceof I_))return U(16599,{dt:e.type});t={verify:Mi(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map((r=>(function(o,a){const u=a.transform;if(u instanceof us)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(u instanceof ar)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:u.elements}};if(u instanceof cr)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:u.elements}};if(u instanceof ls)return{fieldPath:a.field.canonicalString(),increment:u.Ae};throw U(20930,{transform:a.transform})})(0,r)))),e.precondition.isNone||(t.currentDocument=(function(s,o){return o.updateTime!==void 0?{updateTime:N_(s,o.updateTime)}:o.exists!==void 0?{exists:o.exists}:U(27497)})(n,e.precondition)),t}function x_(n,e){return n&&n.length>0?(K(e!==void 0,14353),n.map((t=>(function(s,o){let a=s.updateTime?je(s.updateTime):je(o);return a.isEqual(B.min())&&(a=je(o)),new y_(a,s.transformResults||[])})(t,e)))):[]}function F_(n,e){return{documents:[Jl(n,e.path)]}}function U_(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=Jl(n,s);const o=(function(d){if(d.length!==0)return eh(Le.create(d,"and"))})(e.filters);o&&(t.structuredQuery.where=o);const a=(function(d){if(d.length!==0)return d.map((p=>(function(_){return{field:Xt(_.field),direction:j_(_.dir)}})(p)))})(e.orderBy);a&&(t.structuredQuery.orderBy=a);const u=Oi(n,e.limit);return u!==null&&(t.structuredQuery.limit=u),e.startAt&&(t.structuredQuery.startAt=(function(d){return{before:d.inclusive,values:d.position}})(e.startAt)),e.endAt&&(t.structuredQuery.endAt=(function(d){return{before:!d.inclusive,values:d.position}})(e.endAt)),{ft:t,parent:s}}function B_(n){let e=O_(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){K(r===1,65062);const p=t.from[0];p.allDescendants?s=p.collectionId:e=e.child(p.collectionId)}let o=[];t.where&&(o=(function(E){const _=Zl(E);return _ instanceof Le&&Cl(_)?_.getFilters():[_]})(t.where));let a=[];t.orderBy&&(a=(function(E){return E.map((_=>(function(P){return new or(Zt(P.field),(function(V){switch(V){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}})(P.direction))})(_)))})(t.orderBy));let u=null;t.limit&&(u=(function(E){let _;return _=typeof E=="object"?E.value:E,vs(_)?null:_})(t.limit));let h=null;t.startAt&&(h=(function(E){const _=!!E.before,S=E.values||[];return new cs(S,_)})(t.startAt));let d=null;return t.endAt&&(d=(function(E){const _=!E.before,S=E.values||[];return new cs(S,_)})(t.endAt)),r_(e,s,a,o,u,"F",h,d)}function q_(n,e){const t=(function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return U(28987,{purpose:s})}})(e.purpose);return t==null?null:{"goog-listen-tags":t}}function Zl(n){return n.unaryFilter!==void 0?(function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=Zt(t.unaryFilter.field);return re.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=Zt(t.unaryFilter.field);return re.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const o=Zt(t.unaryFilter.field);return re.create(o,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=Zt(t.unaryFilter.field);return re.create(a,"!=",{nullValue:"NULL_VALUE"});case"OPERATOR_UNSPECIFIED":return U(61313);default:return U(60726)}})(n):n.fieldFilter!==void 0?(function(t){return re.create(Zt(t.fieldFilter.field),(function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";case"OPERATOR_UNSPECIFIED":return U(58110);default:return U(50506)}})(t.fieldFilter.op),t.fieldFilter.value)})(n):n.compositeFilter!==void 0?(function(t){return Le.create(t.compositeFilter.filters.map((r=>Zl(r))),(function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return U(1026)}})(t.compositeFilter.op))})(n):U(30097,{filter:n})}function j_(n){return C_[n]}function $_(n){return k_[n]}function z_(n){return V_[n]}function Xt(n){return{fieldPath:n.canonicalString()}}function Zt(n){return he.fromServerFormat(n.fieldPath)}function eh(n){return n instanceof re?(function(t){if(t.op==="=="){if(Pc(t.value))return{unaryFilter:{field:Xt(t.field),op:"IS_NAN"}};if(Sc(t.value))return{unaryFilter:{field:Xt(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(Pc(t.value))return{unaryFilter:{field:Xt(t.field),op:"IS_NOT_NAN"}};if(Sc(t.value))return{unaryFilter:{field:Xt(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Xt(t.field),op:$_(t.op),value:t.value}}})(n):n instanceof Le?(function(t){const r=t.getFilters().map((s=>eh(s)));return r.length===1?r[0]:{compositeFilter:{op:z_(t.op),filters:r}}})(n):U(54877,{filter:n})}function W_(n){const e=[];return n.fields.forEach((t=>e.push(t.canonicalString()))),{fieldPaths:e}}function th(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}function nh(n){return!!n&&typeof n._toProto=="function"&&n._protoValueType==="ProtoValue"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H_{constructor(e){this.yt=e}}function G_(n){const e=B_({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Ni(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oy{constructor(){this.sessionToken=de.EMPTY_BYTE_STRING}getSessionToken(e){return C.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,C.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fy{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=(function(){return Fd()?8:xg(Te())>0?6:4})()}initialize(e,t){this.fs=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.gs(e,t).next((a=>{o.result=a})).next((()=>{if(!o.result)return this.ps(e,t,s,r).next((a=>{o.result=a}))})).next((()=>{if(o.result)return;const a=new dy;return this.ys(e,t,a).next((u=>{if(o.result=u,this.As)return this.ws(e,t,a,u.size)}))})).next((()=>o.result))}ws(e,t,r,s){return r.documentReadCount<this.Vs?(Yt()<=z.DEBUG&&O("QueryEngine","SDK will not create cache indexes for query:",Jt(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),C.resolve()):(Yt()<=z.DEBUG&&O("QueryEngine","Query:",Jt(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.ds*s?(Yt()<=z.DEBUG&&O("QueryEngine","The SDK decides to create cache indexes for query:",Jt(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Be(t))):C.resolve())}gs(e,t){if(Vc(t))return C.resolve(null);let r=Be(t);return this.indexManager.getIndexType(e,r).next((s=>s===0?null:(t.limit!==null&&s===1&&(t=Ni(t,null,"F"),r=Be(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next((o=>{const a=H(...o);return this.fs.getDocuments(e,a).next((u=>this.indexManager.getMinOffset(e,r).next((h=>{const d=this.bs(t,u);return this.Ss(t,d,a,h.readTime)?this.gs(e,Ni(t,null,"F")):this.Ds(e,d,t,h)}))))})))))}ps(e,t,r,s){return Vc(t)||s.isEqual(B.min())?C.resolve(null):this.fs.getDocuments(e,r).next((o=>{const a=this.bs(t,o);return this.Ss(t,a,r,s)?C.resolve(null):(Yt()<=z.DEBUG&&O("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),Jt(t)),this.Ds(e,a,t,Dg(s,nr)).next((u=>u)))}))}bs(e,t){let r=new ae(Ll(e));return t.forEach(((s,o)=>{Ss(e,o)&&(r=r.add(o))})),r}Ss(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}ys(e,t,r){return Yt()<=z.DEBUG&&O("QueryEngine","Using full collection scan to execute query:",Jt(t)),this.fs.getDocumentsMatchingQuery(e,t,gt.min(),r)}Ds(e,t,r,s){return this.fs.getDocumentsMatchingQuery(e,r,s).next((o=>(t.forEach((a=>{o=o.insert(a.key,a)})),o)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eo="LocalStore",py=3e8;class my{constructor(e,t,r,s){this.persistence=e,this.Cs=t,this.serializer=s,this.vs=new Z(W),this.Fs=new $t((o=>ao(o)),co),this.Ms=new Map,this.xs=e.getRemoteDocumentCache(),this.li=e.getTargetCache(),this.Pi=e.getBundleCache(),this.Os(r)}Os(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new ry(this.xs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.xs.setIndexManager(this.indexManager),this.Cs.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",(t=>e.collect(t,this.vs)))}}function gy(n,e,t,r){return new my(n,e,t,r)}async function ih(n,e){const t=q(n);return await t.persistence.runTransaction("Handle user change","readonly",(r=>{let s;return t.mutationQueue.getAllMutationBatches(r).next((o=>(s=o,t.Os(e),t.mutationQueue.getAllMutationBatches(r)))).next((o=>{const a=[],u=[];let h=H();for(const d of s){a.push(d.batchId);for(const p of d.mutations)h=h.add(p.key)}for(const d of o){u.push(d.batchId);for(const p of d.mutations)h=h.add(p.key)}return t.localDocuments.getDocuments(r,h).next((d=>({Ns:d,removedBatchIds:a,addedBatchIds:u})))}))}))}function _y(n,e){const t=q(n);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",(r=>{const s=e.batch.keys(),o=t.xs.newChangeBuffer({trackRemovals:!0});return(function(u,h,d,p){const E=d.batch,_=E.keys();let S=C.resolve();return _.forEach((P=>{S=S.next((()=>p.getEntry(h,P))).next((k=>{const V=d.docVersions.get(P);K(V!==null,48541),k.version.compareTo(V)<0&&(E.applyToRemoteDocument(k,d),k.isValidDocument()&&(k.setReadTime(d.commitVersion),p.addEntry(k)))}))})),S.next((()=>u.mutationQueue.removeMutationBatch(h,E)))})(t,r,e,o).next((()=>o.apply(r))).next((()=>t.mutationQueue.performConsistencyCheck(r))).next((()=>t.documentOverlayCache.removeOverlaysForBatchId(r,s,e.batch.batchId))).next((()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(r,(function(u){let h=H();for(let d=0;d<u.mutationResults.length;++d)u.mutationResults[d].transformResults.length>0&&(h=h.add(u.batch.mutations[d].key));return h})(e)))).next((()=>t.localDocuments.getDocuments(r,s)))}))}function oh(n){const e=q(n);return e.persistence.runTransaction("Get last remote snapshot version","readonly",(t=>e.li.getLastRemoteSnapshotVersion(t)))}function yy(n,e){const t=q(n),r=e.snapshotVersion;let s=t.vs;return t.persistence.runTransaction("Apply remote event","readwrite-primary",(o=>{const a=t.xs.newChangeBuffer({trackRemovals:!0});s=t.vs;const u=[];e.targetChanges.forEach(((p,E)=>{const _=s.get(E);if(!_)return;u.push(t.li.removeMatchingKeys(o,p.removedDocuments,E).next((()=>t.li.addMatchingKeys(o,p.addedDocuments,E))));let S=_.withSequenceNumber(o.currentSequenceNumber);e.targetMismatches.get(E)!==null?S=S.withResumeToken(de.EMPTY_BYTE_STRING,B.min()).withLastLimboFreeSnapshotVersion(B.min()):p.resumeToken.approximateByteSize()>0&&(S=S.withResumeToken(p.resumeToken,r)),s=s.insert(E,S),(function(k,V,x){return k.resumeToken.approximateByteSize()===0||V.snapshotVersion.toMicroseconds()-k.snapshotVersion.toMicroseconds()>=py?!0:x.addedDocuments.size+x.modifiedDocuments.size+x.removedDocuments.size>0})(_,S,p)&&u.push(t.li.updateTargetData(o,S))}));let h=Je(),d=H();if(e.documentUpdates.forEach((p=>{e.resolvedLimboDocuments.has(p)&&u.push(t.persistence.referenceDelegate.updateLimboDocument(o,p))})),u.push(Ey(o,a,e.documentUpdates).next((p=>{h=p.Bs,d=p.Ls}))),!r.isEqual(B.min())){const p=t.li.getLastRemoteSnapshotVersion(o).next((E=>t.li.setTargetsMetadata(o,o.currentSequenceNumber,r)));u.push(p)}return C.waitFor(u).next((()=>a.apply(o))).next((()=>t.localDocuments.getLocalViewOfDocuments(o,h,d))).next((()=>h))})).then((o=>(t.vs=s,o)))}function Ey(n,e,t){let r=H(),s=H();return t.forEach((o=>r=r.add(o))),e.getEntries(n,r).next((o=>{let a=Je();return t.forEach(((u,h)=>{const d=o.get(u);h.isFoundDocument()!==d.isFoundDocument()&&(s=s.add(u)),h.isNoDocument()&&h.version.isEqual(B.min())?(e.removeEntry(u,h.readTime),a=a.insert(u,h)):!d.isValidDocument()||h.version.compareTo(d.version)>0||h.version.compareTo(d.version)===0&&d.hasPendingWrites?(e.addEntry(h),a=a.insert(u,h)):O(Eo,"Ignoring outdated watch update for ",u,". Current version:",d.version," Watch version:",h.version)})),{Bs:a,Ls:s}}))}function Ty(n,e){const t=q(n);return t.persistence.runTransaction("Get next mutation batch","readonly",(r=>(e===void 0&&(e=so),t.mutationQueue.getNextMutationBatchAfterBatchId(r,e))))}function Iy(n,e){const t=q(n);return t.persistence.runTransaction("Allocate target","readwrite",(r=>{let s;return t.li.getTargetData(r,e).next((o=>o?(s=o,C.resolve(s)):t.li.allocateTargetId(r).next((a=>(s=new ut(e,a,"TargetPurposeListen",r.currentSequenceNumber),t.li.addTargetData(r,s).next((()=>s)))))))})).then((r=>{const s=t.vs.get(r.targetId);return(s===null||r.snapshotVersion.compareTo(s.snapshotVersion)>0)&&(t.vs=t.vs.insert(r.targetId,r),t.Fs.set(e,r.targetId)),r}))}async function Fi(n,e,t){const r=q(n),s=r.vs.get(e),o=t?"readwrite":"readwrite-primary";try{t||await r.persistence.runTransaction("Release target",o,(a=>r.persistence.referenceDelegate.removeTarget(a,s)))}catch(a){if(!Tn(a))throw a;O(Eo,`Failed to update sequence numbers for target ${e}: ${a}`)}r.vs=r.vs.remove(e),r.Fs.delete(s.target)}function zc(n,e,t){const r=q(n);let s=B.min(),o=H();return r.persistence.runTransaction("Execute query","readwrite",(a=>(function(h,d,p){const E=q(h),_=E.Fs.get(p);return _!==void 0?C.resolve(E.vs.get(_)):E.li.getTargetData(d,p)})(r,a,Be(e)).next((u=>{if(u)return s=u.lastLimboFreeSnapshotVersion,r.li.getMatchingKeysForTargetId(a,u.targetId).next((h=>{o=h}))})).next((()=>r.Cs.getDocumentsMatchingQuery(a,e,t?s:B.min(),t?o:H()))).next((u=>(wy(r,a_(e),u),{documents:u,ks:o})))))}function wy(n,e,t){let r=n.Ms.get(e)||B.min();t.forEach(((s,o)=>{o.readTime.compareTo(r)>0&&(r=o.readTime)})),n.Ms.set(e,r)}class Wc{constructor(){this.activeTargetIds=f_()}Qs(e){this.activeTargetIds=this.activeTargetIds.add(e)}Gs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Ws(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class vy{constructor(){this.vo=new Wc,this.Fo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,r){}addLocalQueryTarget(e,t=!0){return t&&this.vo.Qs(e),this.Fo[e]||"not-current"}updateQueryState(e,t,r){this.Fo[e]=t}removeLocalQueryTarget(e){this.vo.Gs(e)}isLocalQueryTarget(e){return this.vo.activeTargetIds.has(e)}clearQueryState(e){delete this.Fo[e]}getAllActiveQueryTargets(){return this.vo.activeTargetIds}isActiveQueryTarget(e){return this.vo.activeTargetIds.has(e)}start(){return this.vo=new Wc,Promise.resolve()}handleUserChange(e,t,r){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hc="ConnectivityMonitor";class Gc{constructor(){this.xo=()=>this.Oo(),this.No=()=>this.Bo(),this.Lo=[],this.ko()}Mo(e){this.Lo.push(e)}shutdown(){window.removeEventListener("online",this.xo),window.removeEventListener("offline",this.No)}ko(){window.addEventListener("online",this.xo),window.addEventListener("offline",this.No)}Oo(){O(Hc,"Network connectivity changed: AVAILABLE");for(const e of this.Lo)e(0)}Bo(){O(Hc,"Network connectivity changed: UNAVAILABLE");for(const e of this.Lo)e(1)}static v(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e="WebChannelConnection",Un=(n,e,t)=>{n.listen(e,(r=>{try{t(r)}catch(s){setTimeout((()=>{throw s}),0)}}))};class sn extends Sy{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!sn.c_){const e=hl();Un(e,ll.STAT_EVENT,(t=>{t.stat===Si.PROXY?O(_e,"STAT_EVENT: detected buffering proxy"):t.stat===Si.NOPROXY&&O(_e,"STAT_EVENT: detected no buffering proxy")})),sn.c_=!0}}zo(e,t,r,s,o){const a=Ui();return new Promise(((u,h)=>{const d=new cl;d.setWithCredentials(!0),d.listenOnce(ul.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case Wr.NO_ERROR:const E=d.getResponseJson();O(_e,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(E)),u(E);break;case Wr.TIMEOUT:O(_e,`RPC '${e}' ${a} timed out`),h(new N(b.DEADLINE_EXCEEDED,"Request time out"));break;case Wr.HTTP_ERROR:const _=d.getStatus();if(O(_e,`RPC '${e}' ${a} failed with status:`,_,"response text:",d.getResponseText()),_>0){let S=d.getResponseJson();Array.isArray(S)&&(S=S[0]);const P=S==null?void 0:S.error;if(P&&P.status&&P.message){const k=(function(x){const M=x.toLowerCase().replace(/_/g,"-");return Object.values(b).indexOf(M)>=0?M:b.UNKNOWN})(P.status);h(new N(k,P.message))}else h(new N(b.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new N(b.UNAVAILABLE,"Connection failed."));break;default:U(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{O(_e,`RPC '${e}' ${a} completed.`)}}));const p=JSON.stringify(s);O(_e,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",p,r,15)}))}T_(e,t,r){const s=Ui(),o=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Go(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const d=o.join("");O(_e,`Creating RPC '${e}' stream ${s}: ${d}`,u);const p=a.createWebChannel(d,u);this.I_(p);let E=!1,_=!1;const S=new Py({Ho:P=>{_?O(_e,`Not sending because RPC '${e}' stream ${s} is closed:`,P):(E||(O(_e,`Opening RPC '${e}' stream ${s} transport.`),p.open(),E=!0),O(_e,`RPC '${e}' stream ${s} sending:`,P),p.send(P))},Jo:()=>p.close()});return Un(p,jn.EventType.OPEN,(()=>{_||(O(_e,`RPC '${e}' stream ${s} transport opened.`),S.i_())})),Un(p,jn.EventType.CLOSE,(()=>{_||(_=!0,O(_e,`RPC '${e}' stream ${s} transport closed`),S.o_(),this.E_(p))})),Un(p,jn.EventType.ERROR,(P=>{_||(_=!0,Ft(_e,`RPC '${e}' stream ${s} transport errored. Name:`,P.name,"Message:",P.message),S.o_(new N(b.UNAVAILABLE,"The operation could not be completed")))})),Un(p,jn.EventType.MESSAGE,(P=>{var k;if(!_){const V=P.data[0];K(!!V,16349);const x=V,M=(x==null?void 0:x.error)||((k=x[0])==null?void 0:k.error);if(M){O(_e,`RPC '${e}' stream ${s} received error:`,M);const $=M.status;let fe=(function(I){const m=ne[I];if(m!==void 0)return Hl(m)})($),pe=M.message;$==="NOT_FOUND"&&pe.includes("database")&&pe.includes("does not exist")&&pe.includes(this.databaseId.database)&&Ft(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),fe===void 0&&(fe=b.INTERNAL,pe="Unknown error status: "+$+" with message "+M.message),_=!0,S.o_(new N(fe,pe)),p.close()}else O(_e,`RPC '${e}' stream ${s} received:`,V),S.__(V)}})),sn.u_(),setTimeout((()=>{S.s_()}),0),S}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,r){super.Go(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return dl()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut="RemoteStore";class Ly{constructor(e,t,r,s,o){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Ta=[],this.Ia=new Map,this.Ea=new Set,this.Ra=[],this.Aa=o,this.Aa.Mo((a=>{r.enqueueAndForget((async()=>{Wt(this)&&(O(Ut,"Restarting streams for network reachability change."),await(async function(h){const d=q(h);d.Ea.add(4),await yr(d),d.Va.set("Unknown"),d.Ea.delete(4),await Vs(d)})(this))}))})),this.Va=new Oy(r,s)}}async function Vs(n){if(Wt(n))for(const e of n.Ra)await e(!0)}async function yr(n){for(const e of n.Ra)await e(!1)}function uh(n,e){const t=q(n);t.Ia.has(e.targetId)||(t.Ia.set(e.targetId,e),vo(t)?wo(t):wn(t).O_()&&Io(t,e))}function To(n,e){const t=q(n),r=wn(t);t.Ia.delete(e),r.O_()&&lh(t,e),t.Ia.size===0&&(r.O_()?r.L_():Wt(t)&&t.Va.set("Unknown"))}function Io(n,e){if(n.da.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(B.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}wn(n).Z_(e)}function lh(n,e){n.da.$e(e),wn(n).X_(e)}function wo(n){n.da=new b_({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),At:e=>n.Ia.get(e)||null,ht:()=>n.datastore.serializer.databaseId}),wn(n).start(),n.Va.ua()}function vo(n){return Wt(n)&&!wn(n).x_()&&n.Ia.size>0}function Wt(n){return q(n).Ea.size===0}function hh(n){n.da=void 0}async function My(n){n.Va.set("Online")}async function xy(n){n.Ia.forEach(((e,t)=>{Io(n,e)}))}async function Fy(n,e){hh(n),vo(n)?(n.Va.ha(e),wo(n)):n.Va.set("Unknown")}async function Uy(n,e,t){if(n.Va.set("Online"),e instanceof Kl&&e.state===2&&e.cause)try{await(async function(s,o){const a=o.cause;for(const u of o.targetIds)s.Ia.has(u)&&(await s.remoteSyncer.rejectListen(u,a),s.Ia.delete(u),s.da.removeTarget(u))})(n,e)}catch(r){O(Ut,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await fs(n,r)}else if(e instanceof Qr?n.da.Xe(e):e instanceof Gl?n.da.st(e):n.da.tt(e),!t.isEqual(B.min()))try{const r=await oh(n.localStore);t.compareTo(r)>=0&&await(function(o,a){const u=o.da.Tt(a);return u.targetChanges.forEach(((h,d)=>{if(h.resumeToken.approximateByteSize()>0){const p=o.Ia.get(d);p&&o.Ia.set(d,p.withResumeToken(h.resumeToken,a))}})),u.targetMismatches.forEach(((h,d)=>{const p=o.Ia.get(h);if(!p)return;o.Ia.set(h,p.withResumeToken(de.EMPTY_BYTE_STRING,p.snapshotVersion)),lh(o,h);const E=new ut(p.target,h,d,p.sequenceNumber);Io(o,E)})),o.remoteSyncer.applyRemoteEvent(u)})(n,t)}catch(r){O(Ut,"Failed to raise snapshot:",r),await fs(n,r)}}async function fs(n,e,t){if(!Tn(e))throw e;n.Ea.add(1),await yr(n),n.Va.set("Offline"),t||(t=()=>oh(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{O(Ut,"Retrying IndexedDB access"),await t(),n.Ea.delete(1),await Vs(n)}))}function dh(n,e){return e().catch((t=>fs(n,t,e)))}async function Ds(n){const e=q(n),t=Tt(e);let r=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:so;for(;By(e);)try{const s=await Ty(e.localStore,r);if(s===null){e.Ta.length===0&&t.L_();break}r=s.batchId,qy(e,s)}catch(s){await fs(e,s)}fh(e)&&ph(e)}function By(n){return Wt(n)&&n.Ta.length<10}function qy(n,e){n.Ta.push(e);const t=Tt(n);t.O_()&&t.Y_&&t.ea(e.mutations)}function fh(n){return Wt(n)&&!Tt(n).x_()&&n.Ta.length>0}function ph(n){Tt(n).start()}async function jy(n){Tt(n).ra()}async function $y(n){const e=Tt(n);for(const t of n.Ta)e.ea(t.mutations)}async function zy(n,e,t){const r=n.Ta.shift(),s=fo.from(r,e,t);await dh(n,(()=>n.remoteSyncer.applySuccessfulWrite(s))),await Ds(n)}async function Wy(n,e){e&&Tt(n).Y_&&await(async function(r,s){if((function(a){return R_(a)&&a!==b.ABORTED})(s.code)){const o=r.Ta.shift();Tt(r).B_(),await dh(r,(()=>r.remoteSyncer.rejectFailedWrite(o.batchId,s))),await Ds(r)}})(n,e),fh(n)&&ph(n)}async function Qc(n,e){const t=q(n);t.asyncQueue.verifyOperationInProgress(),O(Ut,"RemoteStore received new credentials");const r=Wt(t);t.Ea.add(3),await yr(t),r&&t.Va.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ea.delete(3),await Vs(t)}async function Hy(n,e){const t=q(n);e?(t.Ea.delete(2),await Vs(t)):e||(t.Ea.add(2),await yr(t),t.Va.set("Unknown"))}function wn(n){return n.ma||(n.ma=(function(t,r,s){const o=q(t);return o.sa(),new Cy(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)})(n.datastore,n.asyncQueue,{Zo:My.bind(null,n),Yo:xy.bind(null,n),t_:Fy.bind(null,n),J_:Uy.bind(null,n)}),n.Ra.push((async e=>{e?(n.ma.B_(),vo(n)?wo(n):n.Va.set("Unknown")):(await n.ma.stop(),hh(n))}))),n.ma}function Tt(n){return n.fa||(n.fa=(function(t,r,s){const o=q(t);return o.sa(),new ky(r,o.connection,o.authCredentials,o.appCheckCredentials,o.serializer,s)})(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),Yo:jy.bind(null,n),t_:Wy.bind(null,n),ta:$y.bind(null,n),na:zy.bind(null,n)}),n.Ra.push((async e=>{e?(n.fa.B_(),await Ds(n)):(await n.fa.stop(),n.Ta.length>0&&(O(Ut,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ht{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Ht(this.firestore,e,this._query)}}class oe{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new mt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new oe(this.firestore,e,this._key)}toJSON(){return{type:oe._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,r){if(mr(t,oe._jsonSchema))return new oe(e,r||null,new L(Y.fromString(t.referencePath)))}}oe._jsonSchemaVersion="firestore/documentReference/1.0",oe._jsonSchema={type:se("string",oe._jsonSchemaVersion),referencePath:se("string")};class mt extends Ht{constructor(e,t,r){super(e,t,uo(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new oe(this.firestore,null,new L(e))}withConverter(e){return new mt(this.firestore,e,this._path)}}function ou(n,e,...t){if(n=Ie(n),ml("collection","path",e),n instanceof Ns){const r=Y.fromString(e,...t);return _c(r),new mt(n,null,r)}{if(!(n instanceof oe||n instanceof mt))throw new N(b.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(Y.fromString(e,...t));return _c(r),new mt(n.firestore,null,r)}}function Sh(n,e,...t){if(n=Ie(n),arguments.length===1&&(e=ro.newId()),ml("doc","path",e),n instanceof Ns){const r=Y.fromString(e,...t);return gc(r),new oe(n,null,new L(r))}{if(!(n instanceof oe||n instanceof mt))throw new N(b.INVALID_ARGUMENT,"Expected first argument to doc() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(Y.fromString(e,...t));return gc(r),new oe(n.firestore,n instanceof mt?n.converter:null,new L(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bh{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new N(b.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new he(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $e{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new N(b.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new N(b.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return W(this._lat,e._lat)||W(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:$e._jsonSchemaVersion}}static fromJSON(e){if(mr(e,$e._jsonSchema))return new $e(e.latitude,e.longitude)}}$e._jsonSchemaVersion="firestore/geoPoint/1.0",$e._jsonSchema={type:se("string",$e._jsonSchemaVersion),latitude:se("number"),longitude:se("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oe{constructor(e){this._values=(e||[]).map((t=>t))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(r,s){if(r.length!==s.length)return!1;for(let o=0;o<r.length;++o)if(r[o]!==s[o])return!1;return!0})(this._values,e._values)}toJSON(){return{type:Oe._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(mr(e,Oe._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((t=>typeof t=="number")))return new Oe(e.vectorValues);throw new N(b.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Oe._jsonSchemaVersion="firestore/vectorValue/1.0",Oe._jsonSchema={type:se("string",Oe._jsonSchemaVersion),vectorValues:se("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */an._jsonSchemaVersion="firestore/querySnapshot/1.0",an._jsonSchema={type:se("string",an._jsonSchemaVersion),bundleSource:se("string","QuerySnapshot"),bundleName:se("string"),bundle:se("string")};function zE(n){return Uh(rn(n.firestore,ur),[new ho(n._key,qe.none())])}function WE(n,e){const t=rn(n.firestore,ur),r=Sh(n),s=jE(n.converter,e),o=Vh(n.firestore);return Uh(t,[DE(o,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,qe.exists(!1))]).then((()=>r))}function HE(n,...e){var d,p,E;n=Ie(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||du(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(du(e[r])){const _=e[r];e[r]=(d=_.next)==null?void 0:d.bind(_),e[r+1]=(p=_.error)==null?void 0:p.bind(_),e[r+2]=(E=_.complete)==null?void 0:E.bind(_)}let o,a,u;if(n instanceof oe)a=rn(n.firestore,ur),u=uo(n._key.path),o={next:_=>{e[r]&&e[r](GE(a,n,_))},error:e[r+1],complete:e[r+2]};else{const _=rn(n,Ht);a=rn(_.firestore,ur),u=_._query;const S=new Lh(a);o={next:P=>{e[r]&&e[r](new an(a,S,_,P))},error:e[r+1],complete:e[r+2]},UE(n._query)}const h=Ph(a);return wE(h,u,s,o)}function Uh(n,e){const t=Ph(n);return vE(t,e)}function GE(n,e,t){const r=t.docs.get(e._key),s=new Lh(n);return new Nt(n,s,e._key,r,new Wn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){Tg(gn),cn(new Lt("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new ur(new vg(r.getProvider("auth-internal")),new Sg(a,r.getProvider("app-check-internal")),$g(a,s),a);return o={useFetchStreams:t,...o},u._setSettings(o),u}),"PUBLIC").setMultipleInstances(!0)),dt(lu,hu,e),dt(lu,hu,"esm2020")})();const KE={apiKey:"AIzaSyBrhhpGsDEIH46um9FS2j8uTleOwzPrHZ8",authDomain:"coda-tax.firebaseapp.com",projectId:"coda-tax",storageBucket:"coda-tax.firebasestorage.app",messagingSenderId:"788663710911",appId:"1:788663710911:web:33143712e512d6253c820a",measurementId:"G-LYGK290Y1Z"},Bh=Ru(KE),Hn=yg(Bh),_i=PE(Bh);Hn.onAuthStateChanged(n=>{const e=window.location.hash;!n&&e.startsWith("#/dashboard")&&(window.location.hash="#/")});"serviceWorker"in navigator&&navigator.serviceWorker.getRegistrations().then(function(n){for(let e of n)e.unregister()});caches.keys().then(function(n){for(let e of n)caches.delete(e)});console.log("Force cleared SW and Caches");window.kodaEngine=(()=>{let n={isSubscribed:!1,currentUser:null,records:[],categories:[{id:"수입 합계",keywords:["애드센스","협찬","수입","입금","광고수익","도네","후원","정산"],type:"income",box:"수입"},{id:"식대",keywords:["식대","밥","회식","미팅","커피","편의점","식사","음식","음식비","외식","식사비"],type:"expense",box:"15"},{id:"여비교통비",keywords:["교통","차비","택시","버스","지하철","주유","기름","톨게이트","주차"],type:"expense",box:"15"},{id:"촬영소품",keywords:["소품","배경","의상","분장","액세서리","가발"],type:"expense",box:"11"},{id:"장비비",keywords:["장비","카메라","마이크","조명","렌즈","컴퓨터","PC","모니터","삼각대"],type:"expense",box:"22"},{id:"소프트웨어/구독",keywords:["구독","툴","프로그램","편집툴","클라우드","어도비","프리미어","라이선스","폰트"],type:"expense",box:"22"},{id:"외주/편집",keywords:["외주","편집","디자인","썸네일","컷편집","제작비"],type:"expense",box:"21"},{id:"통신비",keywords:["통신","인터넷","휴대폰","요금제"],type:"expense",box:"19"},{id:"소모품비",keywords:["소모품","사무용품","펜","종이","문구","건전지"],type:"expense",box:"22"},{id:"수선유지비",keywords:["수선","유지","수리","보수","수리비"],type:"expense",box:"22"},{id:"월세/임차료",keywords:["월세","임대료","임차료","관리비","스튜디오"],type:"expense",box:"13"},{id:"수도광열비",keywords:["수도","전기","가스","난방","냉난방"],type:"expense",box:"18"},{id:"보험료",keywords:["보험","국민연금","건강보험","자동차보험","산재"],type:"expense",box:"15"},{id:"세금과공과",keywords:["세금","면허세","재산세","공과금","범칙금"],type:"expense",box:"20"},{id:"지급수수료",keywords:["수수료","뱅킹수수료","결제수수료","이체수수료"],type:"expense",box:"21"},{id:"광고선전비",keywords:["광고","홍보","마케팅"],type:"expense",box:"22"},{id:"기타필요경비",keywords:[],type:"expense",box:"22"}],lastDetected:null,recognition:null,isAuthInitialized:!1,voiceTargetYear:null,currentYear:2026,allRecords:[],activeReportType:null};const e=_=>document.getElementById(_),t=_=>new Intl.NumberFormat("ko-KR").format(Math.floor(_)),r=(_,S="success")=>{let P=e("app-toast");P||(P=document.createElement("div"),P.id="app-toast",document.body.appendChild(P)),P.innerText=_,P.className=`toast-visible ${S}`,setTimeout(()=>P.className="",3e3)},s={11:{label:"매입비용(촬영소품)",scope:"콘텐츠 촬영용 소품, 의상, 배경지 등"},13:{label:"임차료(스튜디오)",scope:"사업장/스튜디오 월세 및 관리비"},14:{label:"접대비(미팅식대)",scope:"비즈니스 식대 및 협력자 선물"},15:{label:"복리후생비(식대)",scope:"본인 외 인력 식대, 음료"},17:{label:"여비교통비",scope:"택시비, 기차표, 대중교통"},19:{label:"통신비",scope:"인터넷 요금, 업무용 휴대폰"},21:{label:"지급수수료",scope:"컷편집, 썸네일 제작 외주비"},22:{label:"장비/광고/기타",scope:"카메라, 광고비, 어도비 구독료, 소모품"}},o=_=>{window.location.hash=_==="/"?"#/":`#${_}`,a()},a=()=>{const _=window.location.hash||"#/",S=e("user-type-overlay"),P=e("app-container");!S||!P||n.isAuthInitialized&&(_==="#/dashboard"||_.startsWith("#/dashboard")?n.currentUser?(S.style.display="none",P.style.display="flex",u()):o("/"):(S.style.display="flex",P.style.display="none"))},u=()=>{if(n.currentUser){const P=e("user-status-indicator"),k=e("logged-in-user-id");P&&(P.style.display="block"),k&&(k.innerText=n.currentUser.email.split("@")[0])}const _=e("history-list-mvp");if(!_)return;const S=n.records.slice(0,10);S.length===0?_.innerHTML='<tr><td colspan="5" class="empty-row">기록이 없습니다.</td></tr>':_.innerHTML=S.map(P=>`
                <tr>
                    <td class="cell-date">${P.date.slice(5).replace("-","/")}</td>
                    <td class="cell-type ${P.type}">${P.type==="income"?"수입":"경비"}</td>
                    <td class="cell-cat">${P.label||P.category}</td>
                    <td class="cell-amt">${t(P.amount)}원</td>
                    <td style="text-align:right;"><button class="delete-btn" onclick="kodaEngine.deleteRecord('${P.id}')">✕</button></td>
                </tr>
            `).join("")},h=async()=>{console.log("유튜버 종합소득세 신고앱 시작"),localStorage.getItem("app_v")!=="final"&&(localStorage.setItem("app_v","final"),console.log("App Reset")),window.location.hash!=="#/"&&(window.location.hash="#/"),om(Hn,_=>{if(n.currentUser=_,n.isAuthInitialized=!0,_){const S=BE(ou(_i,"users",_.uid,"records"),qE("date","desc"));HE(S,P=>{const k=P.docs.map(V=>({id:V.id,...V.data()}));n.allRecords=k,n.records=k.filter(V=>V.date&&V.date.startsWith(n.currentYear.toString()+"-")),u(),n.activeReportType==="current"?window.kodaEngine.showYearlyCategorySummary():n.activeReportType==="prev"&&window.kodaEngine.showPrevYearSummary()})}a()}),window.addEventListener("hashchange",a)},d=_=>{let S=0,P=_.replace(/[\s,]/g,"").replace(/원$/g,"");const k=P.match(/([\d\.]+)\s*억/);k&&(S+=parseFloat(k[1])*1e8);const V=P.match(/([\d\.]+)\s*천만/);V&&(S+=parseFloat(V[1])*1e7);const x=P.match(/([\d\.]+)\s*백만/);x&&(S+=parseFloat(x[1])*1e6);const M=P.match(/([\d\.]+)\s*(?!천만|백만)만/);if(M&&(S+=parseFloat(M[1])*1e4),S===0){const $=P.replace(/[^0-9]/g,"");$&&(S=parseInt($))}return S},p=_=>{const S=d(_);let P="기타필요경비";const k=_.toLowerCase();for(const V of n.categories)if(V.keywords.some(x=>k.includes(x))){P=V.id;break}return k.includes("22번")?P="광고선전비":k.includes("15번")?P="식대":k.includes("17번")?P="여비교통비":k.includes("13번")?P="월세/임차료":k.includes("11번")&&(P="촬영소품"),{type:P==="수입 합계"?"income":"expense",category:P,label:_.split(/[0-9]|만|원|억/)[0].trim()||P,amount:S,status:"준비"}},E=()=>{n.recognition&&n.recognition.stop(),e("voice-modal").style.display="none",n.lastDetected=null};return{init:h,login:async _=>{_&&_.preventDefault();const S=e("login-id").value.trim(),P=S.includes("@")?S:`${S}@coda-tax.com`,k=e("login-pw");await rm(Hn,P,k.value.trim()),o("/dashboard")},loginWithGoogle:async()=>{const _=new We;await Pm(Hn,_),o("/dashboard")},logout:async()=>{confirm("로그아웃?")&&(await am(Hn),window.location.reload())},startVoiceRecord:(_=null)=>{const S=window.SpeechRecognition||window.webkitSpeechRecognition;if(!S){alert("이 브라우저는 음성 인식을 지원하지 않습니다.");return}const P=e("voice-modal");P&&(P.style.display="flex");const k=e("voice-status-text"),V=e("voice-transcribed-text"),x=e("voice-result-box");k&&(k.innerText="듣고 있습니다..."),V&&(V.innerText="..."),x&&(x.style.display="none"),n.voiceTargetYear=_||(n.activeReportType==="prev"?n.currentYear-1:n.currentYear),n.recognition||(n.recognition=new S,n.recognition.lang="ko-KR",n.recognition.interimResults=!0,n.recognition.continuous=!1,n.recognition.onstart=()=>{k&&(k.innerText="말씀해 주세요...")},n.recognition.onresult=M=>{const $=M.results[M.results.length-1][0].transcript;V&&(V.innerText=$),M.results[M.results.length-1].isFinal&&(n.lastDetected=p($),x&&(x.style.display="block"),k&&(k.innerText="인식 완료!"))},n.recognition.onend=()=>{!n.lastDetected&&k&&(k.innerText="다시 시도해 주세요.")},n.recognition.onerror=M=>{k&&(k.innerText=`오류: ${M.error}`)});try{n.recognition&&n.recognition.state!=="active"&&n.recognition.start()}catch{n.recognition&&n.recognition.stop(),setTimeout(()=>{try{n.recognition.start()}catch{}},400)}},closeVoiceModal:E,confirmVoiceEntry:async()=>{if(!n.lastDetected)return;const _={...n.lastDetected};_.date=n.voiceTargetYear?`${n.voiceTargetYear}-12-31`:new Date().toISOString().split("T")[0],await WE(ou(_i,"users",n.currentUser.uid,"records"),_),E(),r("실적이 성공적으로 기록되었습니다! 🎉")},deleteRecord:async _=>{confirm("삭제?")&&await zE(Sh(_i,"users",n.currentUser.uid,"records",_))},showYearlyCategorySummary:()=>{n.activeReportType="current";const _=n.records,S={};_.forEach(k=>{var M;const V=n.categories.find($=>$.id===k.category)||{box:"22"},x=`[${V.box}] ${((M=s[V.box])==null?void 0:M.label)||"기타"}`;S[x]=(S[x]||0)+Number(k.amount)});let P='<div style="font-size:0.9rem; position:relative;">';P+=`<div style="background:rgba(59,130,246,0.1); padding:20px; border-radius:16px; margin-bottom:20px; text-align:center;">
                <button onclick="kodaEngine.openBulkModal('${n.currentYear}')" class="btn-primary" style="padding:10px 20px; font-weight:700;">🤖 AI 요약 가이드 열기</button>
            </div>`,Object.keys(S).forEach(k=>{P+=`<div style="display:flex; justify-content:space-between; padding:10px 0; border-bottom:1px solid var(--border-color);"><span>${k}</span><span>${t(S[k])}원</span></div>`}),P+="</div>",e("report-title").innerText=`${n.currentYear}년 실적 (항목별)`,e("report-content").innerHTML=P,e("report-modal").style.display="flex"},showPrevYearSummary:()=>{n.activeReportType="prev";const _=2025,S=n.allRecords.filter(V=>V.date.startsWith(_+"-")),P={};S.forEach(V=>{var $;const x=n.categories.find(fe=>fe.id===V.category)||{box:"22"},M=`[${x.box}] ${(($=s[x.box])==null?void 0:$.label)||"기타"}`;P[M]=(P[M]||0)+Number(V.amount)});let k='<div style="font-size:0.9rem; position:relative;">';k+=`<div style="background:rgba(59,130,246,0.1); padding:20px; border-radius:16px; margin-bottom:20px; text-align:center;">
            ...
            </div>`,Object.keys(P).forEach(V=>{k+=`<div style="display:flex; justify-content:space-between; padding:10px 0; border-bottom:1px solid var(--border-color);"><span>${V}</span><span>${t(P[V])}원</span></div>`}),k+="</div>",e("report-title").innerText="2025년 실적 (전년도)",e("report-content").innerHTML=k,e("report-modal").style.display="flex"},closeReportModal:()=>{const _=e("report-modal");_&&(_.style.display="none")},openBulkModal:_=>{n.voiceTargetYear=_,e("bulk-modal").style.display="flex",e("bulk-input-area").style.display="block"},copyGeminiPrompt:()=>{navigator.clipboard.writeText("내가 결제한 1년 치 내역을 줄게. 아래 홈택스 경비 번호별로 각각 합계를 계산해서 요약해줘..."),alert("AI 요약용 프롬프트가 복사되었습니다! 🤖")}}})();window.addEventListener("DOMContentLoaded",()=>{var n,e;window.kodaEngine.init().catch(console.error),document.querySelectorAll('[id^="close-"]').forEach(t=>{t.addEventListener("click",r=>{const s=r.target.id.replace("close-",""),o=document.getElementById(s+"-modal");o&&(o.style.display="none")})}),(n=get("close-report-modal"))==null||n.addEventListener("click",()=>window.kodaEngine.closeReportModal()),(e=get("close-voice-modal-btn"))==null||e.addEventListener("click",()=>window.kodaEngine.closeVoiceModal())});
