 ...
 */dn._jsonSchemaVersion="firestore/querySnapshot/1.0",dn._jsonSchema={type:ae("string",dn._jsonSchemaVersion),bundleSource:ae("string","QuerySnapshot"),bundleName:ae("string"),bundle:ae("string")};function HE(n){return jh(un(n.firestore,dr),[new po(n._key,We.none())])}function mu(n,e){const t=un(n.firestore,dr),r=bh(n),s=$E(n.converter,e),o=Oh(n.firestore);return jh(t,[NE(o,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,We.exists(!1))]).then((()=>r))}function WE(n,...e){var d,p,T;n=Se(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||du(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(du(e[r])){const v=e[r];e[r]=(d=v.next)==null?void 0:d.bind(v),e[r+1]=(p=v.error)==null?void 0:p.bind(v),e[r+2]=(T=v.complete)==null?void 0:T.bind(v)}let o,a,u;if(n instanceof ue)a=un(n.firestore,dr),u=ho(n._key.path),o={next:v=>{e[r]&&e[r](GE(a,n,v))},error:e[r+1],complete:e[r+2]};else{const v=un(n,Yt);a=un(v.firestore,dr),u=v._query;const C=new Fh(a);o={next:k=>{e[r]&&e[r](new dn(a,C,v,k))},error:e[r+1],complete:e[r+2]},BE(n._query)}const h=kh(a);return vE(h,u,s,o)}function jh(n,e){const t=kh(n);return AE(t,e)}function GE(n,e,t){const r=t.docs.get(e._key),s=new Fh(n);return new xt(n,s,e._key,r,new Qn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){Ig(Tn),fn(new Ut("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new dr(new Ag(r.getProvider("auth-internal")),new Pg(a,r.getProvider("app-check-internal")),zg(a,s),a);return o={useFetchStreams:t,...o},u._setSettings(o),u}),"PUBLIC").setMultipleInstances(!0)),yt(lu,hu,e),yt(lu,hu,"esm2020")})();const KE={apiKey:"AIzaSyBrhhpGsDEIH46um9FS2j8uTleOwzPrHZ8",authDomain:"coda-tax.firebaseapp.com",projectId:"coda-tax",storageBucket:"coda-tax.firebasestorage.app",messagingSenderId:"788663710911",appId:"1:788663710911:web:33143712e512d6253c820a",measurementId:"G-LYGK290Y1Z"},$h=Su(KE),$r=Eg($h),zr=CE($h);window.kodaEngine=(()=>{let n={isSubscribed:!1,currentUser:null,records:[],categories:[{id:"수입 합계",keywords:["애드센스","협찬","수입","입금","광고수익","도네","후원"],type:"income",box:"수입"},{id:"식대",keywords:["식대","밥","회식","미팅","커피"],type:"expense",box:"15"},{id:"여비교통비",keywords:["교통","차비","택시","버스","지하철","주유","기름"],type:"expense",box:"15"},{id:"촬영소품",keywords:["소품","배경","의상","분장"],type:"expense",box:"11"},{id:"장비비",keywords:["장비","카메라","마이크","조명","렌즈","컴퓨터","PC"],type:"expense",box:"22"},{id:"소프트웨어/구독",keywords:["구독","툴","프로그램","편집툴","클라우드","어도비","프리미어","라이선스"],type:"expense",box:"22"},{id:"외주/편집",keywords:["외주","편집","디자인","썸네일","컷편집"],type:"expense",box:"21"},{id:"통신비",keywords:["통신","인터넷","휴대폰"],type:"expense",box:"19"},{id:"소모품비",keywords:["소모품","사무용품","펜","종이","문구"],type:"expense",box:"22"},{id:"수선유지비",keywords:["수선","유지","수리","보수"],type:"expense",box:"22"},{id:"월세/임차료",keywords:["월세","임대료","임차료","관리비"],type:"expense",box:"13"},{id:"수도광열비",keywords:["수도","전기","가스","난방"],type:"expense",box:"18"},{id:"보험료",keywords:["보험","국민연금","건강보험","자동차보험"],type:"expense",box:"15"},{id:"세금과공과",keywords:["세금","면허세","재산세","공과금"],type:"expense",box:"20"},{id:"지급수수료",keywords:["수수료","뱅킹수수료","결제수수료"],type:"expense",box:"21"},{id:"기타필요경비",keywords:[],type:"expense",box:"22"}],lastDetected:null,recognition:null,pendingCategory:null,pendingYear:null};const e=g=>document.getElementById(g),t=g=>new Intl.NumberFormat("ko-KR").format(Math.floor(g)),r=g=>{window.location.hash=g==="/"?"#/":`#${g}`,s()},s=(g=!1)=>{const E=window.location.hash||"#/",m=localStorage.getItem("yt_user_status")==="paid",M=e("user-type-overlay"),U=e("app-container");if(!(!M||!U))if(E==="#/dashboard"||E.startsWith("#/dashboard")){if(!n.currentUser&&!m){r("/");return}M.style.display="none",U.style.display="flex",$()}else{if(g&&n.currentUser){r("/dashboard");return}M.style.display="flex",U.style.display="none"}},o=()=>{am($r,E=>{if(E){n.currentUser=E,n.isSubscribed=!0,localStorage.setItem("yt_user_status","paid");const m=qE(Ti(zr,"users",E.uid,"records"),jE("date","desc"));WE(m,M=>{n.records=M.docs.map(U=>({id:U.id,...U.data()})),$()}),window.location.hash==="#/"&&r("/dashboard")}else n.currentUser=null,n.isSubscribed=!1,n.records=[],localStorage.removeItem("yt_user_status"),r("/"),$()}),s(!0),window.addEventListener("hashchange",()=>s(!1));const g=window.SpeechRecognition||window.webkitSpeechRecognition;g&&(n.recognition=new g,n.recognition.continuous=!1,n.recognition.interimResults=!0,n.recognition.lang="ko-KR",n.recognition.onresult=E=>{const m=e("voice-transcribed-text"),M=e("voice-result-box"),U=e("voice-status-text");let J="",fe="";for(let pe=E.resultIndex;pe<E.results.length;++pe)E.results[pe].isFinal?fe+=E.results[pe][0].transcript:J+=E.results[pe][0].transcript;if(m){const pe=fe||J;pe&&(m.innerText=pe,m.style.display="flex")}fe&&(e("voice-retry-btn")&&(e("voice-retry-btn").style.display="flex"),n.pendingCategory?applyCategoryAmount(fe):(n.lastDetected=u(fe),U&&(U.innerText="음성을 인식했습니다! ✅",U.style.color="var(--success)"),M&&(M.style.display="block")))})},a=g=>{let E=0,m=g.replace(/[\s,]/g,"").replace(/원$/g,"");const M=m.match(/([\d\.]+)\s*억/);M&&(E+=parseFloat(M[1])*1e8);const U=m.match(/([\d\.]+)\s*천만/);U&&(E+=parseFloat(U[1])*1e7);const J=m.match(/([\d\.]+)\s*백만/);J&&(E+=parseFloat(J[1])*1e6);const fe=m.match(/([\d\.]+)\s*(?!천만|백만)만/);if(fe)E+=parseFloat(fe[1])*1e4;else if(!M&&!U&&!J){const Ue=m.match(/([\d\.]+)\s*만/);Ue&&(E+=parseFloat(Ue[1])*1e4)}const pe=m.match(/([\d\.]+)\s*천/);if(pe&&(E+=parseFloat(pe[1])*1e3),E===0){const Ue=m.replace(/[^0-9]/g,"");Ue&&(E=parseInt(Ue))}return E},u=g=>{const E=a(g);let m="기타필요경비";const M=g.toLowerCase();for(const fe of n.categories)if(fe.keywords.some(pe=>M.includes(pe))){m=fe.id;break}const U=new Date;return{date:`${U.getFullYear()}-${(U.getMonth()+1).toString().padStart(2,"0")}-${U.getDate().toString().padStart(2,"0")}`,type:m==="수입 합계"?"income":"expense",category:m,label:g.split(/[0-9]|만|원/)[0].trim()||m,amount:E,status:"준비",memo:g}},h=()=>{n.pendingCategory=null;const g=e("voice-modal"),E=e("voice-status-text"),m=e("voice-transcribed-text"),M=e("voice-result-box");if(m&&(m.innerText="",m.style.display="none"),M&&(M.style.display="none"),e("voice-retry-btn")&&(e("voice-retry-btn").style.display="none"),E&&(E.innerHTML='<span class="rec-dot"></span>듣고 있습니다...',E.style.color="var(--accent)"),g&&(g.style.display="flex"),n.recognition)try{n.recognition.start()}catch{}},d=()=>{n.pendingCategory?y():h()},p=async()=>{if(!(!n.lastDetected||!n.currentUser))try{await mu(Ti(zr,"users",n.currentUser.uid,"records"),n.lastDetected),e("voice-modal").style.display="none",n.lastDetected=null}catch(g){console.error(g),alert("저장 실패")}},T=()=>{const g=["k-c1-v777","k-c2-v777","k-c3-v777","k-c4-v777","k-em-v777","k-ey-v777","k-cv-v777","k-p2-v777"];g.forEach((E,m)=>{const M=e(E);M&&(["focus","click","touchstart"].forEach(U=>{M.addEventListener(U,()=>{/\D/.test(M.value)&&(M.value="")})}),M.addEventListener("input",U=>{let J=U.target.value.replace(/\D/g,"");if(U.target.value=J,J.length>=U.target.maxLength){const fe=e(g[m+1]);fe&&(fe.focus(),fe.tagName==="INPUT"&&fe.select())}}),M.addEventListener("keydown",U=>{if(U.key==="Backspace"&&U.target.value.length===0){const J=e(g[m-1]);J&&(J.focus(),J.tagName==="INPUT"&&J.select())}}))})},v=()=>{e("payment-view-initial").style.display="none",e("payment-view-card").style.display="block",e("payment-view-success").style.display="none",T()},C=()=>{const g=e("btn-pay-v777");g&&(g.style.opacity="0.5"),e("payment-view-initial").style.display="none",e("payment-view-card").style.display="none";const E=e("payment-view-success");E.style.display="block",setTimeout(()=>{g&&(g.style.opacity="1")},1e3)},k=async g=>{g&&g.preventDefault();const E=e("reg-id").value.trim(),m=e("reg-pw").value.trim();if(!E||!m){alert("아이디와 비밀번호를 입력해주세요.");return}const M=g.target.querySelector('button[type="submit"]');M&&(M.disabled=!0,M.innerText="잠시만 기다려주세요...");try{const U=E.includes("@")?E:`${E}@coda-tax.com`;await rm($r,U,m),alert("가입 및 결제가 완료되었습니다!"),e("payment-modal").style.display="none",r("/dashboard")}catch(U){M&&(M.disabled=!1,M.innerText="계정 생성 및 시작하기"),alert("⚠️ "+(U.message||"오류가 발생했습니다."))}},O=async g=>{g&&g.preventDefault();const E=e("login-id").value.trim(),m=e("login-pw").value.trim();if(!E||!m){alert("아이디와 비밀번호를 모두 입력해주세요.");return}try{const M=E.includes("@")?E:`${E}@coda-tax.com`;await sm($r,M,m),r("/dashboard")}catch{alert("로그인에 실패했습니다.")}},N=async()=>{if(confirm("로그아웃 하시겠습니까?"))try{await cm($r),r("/")}catch(g){console.error(g)}},$=()=>{const g=new Date,E=`${g.getFullYear()}-${(g.getMonth()+1).toString().padStart(2,"0")}`,m=n.records.filter(U=>U.date.startsWith(E)).sort((U,J)=>new Date(J.date)-new Date(U.date));n.currentUser&&(e("user-status-indicator").style.display="block",e("logged-in-user-id").innerText=n.currentUser.email.split("@")[0]);const M=e("history-list-mvp");if(M){const U=m.slice(0,10);U.length===0?M.innerHTML='<tr><td colspan="5" class="empty-row">기록이 없습니다.</td></tr>':M.innerHTML=U.map(J=>`
                ...
                `).join("")}},z=async g=>{if(n.currentUser&&confirm("삭제할까요?"))try{await HE(bh(zr,"users",n.currentUser.uid,"records",g))}catch(E){console.error(E)}},Y=()=>{e("payment-view-initial").style.display="block",e("payment-view-card").style.display="none",e("payment-view-success").style.display="none",e("payment-modal").style.display="flex"},Te=()=>r("/"),he=()=>window.open("https://www.hometax.go.kr","_blank"),de=()=>alert("지원 준비중입니다."),I=()=>alert("지원 준비중입니다."),_=()=>alert("지원 준비중입니다."),y=()=>alert("지원 준비중입니다.");return{init:o,startVoiceRecord:h,clearVoiceTranscript:d,confirmVoiceEntry:p,showPrevYearSummary:de,showYearlyCategorySummary:I,copyPrompt:_,startCategoryVoice:y,clearCategoryAmount:()=>alert("지원 준비중입니다."),openHometax:he,deleteRecord:z,goBack:Te,tryStartService:Y,showCardInput:v,confirmSubscription:C,finalizeSignUp:k,login:O,logout:N,openAddModal:()=>e("edit-modal").style.display="flex",saveManualEntry:async g=>{if(g.preventDefault(),!n.currentUser)return;const E={date:e("edit-date").value||new Date().toISOString().split("T")[0],type:e("edit-type").value,category:e("edit-category").value,amount:parseInt(e("edit-amount").value)||0,status:"준비"};try{await mu(Ti(zr,"users",n.currentUser.uid,"records"),E),e("edit-modal").style.display="none"}catch(m){console.error(m)}}}})();
