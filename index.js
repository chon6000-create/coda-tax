 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e="WebChannelConnection",Un=(n,e,t)=>{n.listen(e,(r=>{try{t(r)}catch(s){setTimeout((()=>{throw s}),0)}}))};class on extends Cy{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!on.c_){const e=fl();Un(e,dl.STAT_EVENT,(t=>{t.stat===bi.PROXY?L(_e,"STAT_EVENT: detected buffering proxy"):t.stat===bi.NOPROXY&&L(_e,"STAT_EVENT: detected no buffering proxy")})),on.c_=!0}}zo(e,t,r,s,o){const a=qi();return new Promise(((u,h)=>{const d=new ll;d.setWithCredentials(!0),d.listenOnce(hl.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case Gr.NO_ERROR:const y=d.getResponseJson();L(_e,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(y)),u(y);break;case Gr.TIMEOUT:L(_e,`RPC '${e}' ${a} timed out`),h(new O(C.DEADLINE_EXCEEDED,"Request time out"));break;case Gr.HTTP_ERROR:const w=d.getStatus();if(L(_e,`RPC '${e}' ${a} failed with status:`,w,"response text:",d.getResponseText()),w>0){let V=d.getResponseJson();Array.isArray(V)&&(V=V[0]);const S=V==null?void 0:V.error;if(S&&S.status&&S.message){const b=(function(N){const M=N.toLowerCase().replace(/_/g,"-");return Object.values(C).indexOf(M)>=0?M:C.UNKNOWN})(S.status);h(new O(b,S.message))}else h(new O(C.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new O(C.UNAVAILABLE,"Connection failed."));break;default:U(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{L(_e,`RPC '${e}' ${a} completed.`)}}));const p=JSON.stringify(s);L(_e,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",p,r,15)}))}T_(e,t,r){const s=qi(),o=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Go(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const d=o.join("");L(_e,`Creating RPC '${e}' stream ${s}: ${d}`,u);const p=a.createWebChannel(d,u);this.I_(p);let y=!1,w=!1;const V=new ky({Ho:S=>{w?L(_e,`Not sending because RPC '${e}' stream ${s} is closed:`,S):(y||(L(_e,`Opening RPC '${e}' stream ${s} transport.`),p.open(),y=!0),L(_e,`RPC '${e}' stream ${s} sending:`,S),p.send(S))},Jo:()=>p.close()});return Un(p,$n.EventType.OPEN,(()=>{w||(L(_e,`RPC '${e}' stream ${s} transport opened.`),V.i_())})),Un(p,$n.EventType.CLOSE,(()=>{w||(w=!0,L(_e,`RPC '${e}' stream ${s} transport closed`),V.o_(),this.E_(p))})),Un(p,$n.EventType.ERROR,(S=>{w||(w=!0,qt(_e,`RPC '${e}' stream ${s} transport errored. Name:`,S.name,"Message:",S.message),V.o_(new O(C.UNAVAILABLE,"The operation could not be completed")))})),Un(p,$n.EventType.MESSAGE,(S=>{var b;if(!w){const P=S.data[0];Q(!!P,16349);const N=P,M=(N==null?void 0:N.error)||((b=N[0])==null?void 0:b.error);if(M){L(_e,`RPC '${e}' stream ${s} received error:`,M);const B=M.status;let X=(function(T){const m=se[T];if(m!==void 0)return Kl(m)})(B),K=M.message;B==="NOT_FOUND"&&K.includes("database")&&K.includes("does not exist")&&K.includes(this.databaseId.database)&&qt(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),X===void 0&&(X=C.INTERNAL,K="Unknown error status: "+B+" with message "+M.message),w=!0,V.o_(new O(X,K)),p.close()}else L(_e,`RPC '${e}' stream ${s} received:`,P),V.__(P)}})),on.u_(),setTimeout((()=>{V.s_()}),0),V}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,r){super.Go(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return pl()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Gt(this.firestore,e,this._query)}}class ce{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new mt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new ce(this.firestore,e,this._key)}toJSON(){return{type:ce._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,r){if(gr(t,ce._jsonSchema))return new ce(e,r||null,new x(J.fromString(t.referencePath)))}}ce._jsonSchemaVersion="firestore/documentReference/1.0",ce._jsonSchema={type:oe("string",ce._jsonSchemaVersion),referencePath:oe("string")};class mt extends Gt{constructor(e,t,r){super(e,t,ho(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new ce(this.firestore,null,new x(e))}withConverter(e){return new mt(this.firestore,e,this._path)}}function yi(n,e,...t){if(n=Ie(n),_l("collection","path",e),n instanceof Os){const r=J.fromString(e,...t);return yc(r),new mt(n,null,r)}{if(!(n instanceof ce||n instanceof mt))throw new O(C.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(J.fromString(e,...t));return yc(r),new mt(n.firestore,null,r)}}function bh(n,e,...t){if(n=Ie(n),arguments.length===1&&(e=io.newId()),_l("doc","path",e),n instanceof Os){const r=J.fromString(e,...t);return _c(r),new ce(n,null,new x(r))}{if(!(n instanceof ce||n instanceof mt))throw new O(C.INVALID_ARGUMENT,"Expected first argument to doc() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(J.fromString(e,...t));return _c(r),new ce(n.firestore,n instanceof mt?n.converter:null,new x(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */cn._jsonSchemaVersion="firestore/querySnapshot/1.0",cn._jsonSchema={type:oe("string",cn._jsonSchemaVersion),bundleSource:oe("string","QuerySnapshot"),bundleName:oe("string"),bundle:oe("string")};function GE(n){return qh(sn(n.firestore,ur),[new po(n._key,qe.none())])}function mu(n,e){const t=sn(n.firestore,ur),r=bh(n),s=HE(n.converter,e),o=Nh(n.firestore);return qh(t,[LE(o,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,qe.exists(!1))]).then((()=>r))}function KE(n,...e){var d,p,y;n=Ie(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||du(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(du(e[r])){const w=e[r];e[r]=(d=w.next)==null?void 0:d.bind(w),e[r+1]=(p=w.error)==null?void 0:p.bind(w),e[r+2]=(y=w.complete)==null?void 0:y.bind(w)}let o,a,u;if(n instanceof ce)a=sn(n.firestore,ur),u=ho(n._key.path),o={next:w=>{e[r]&&e[r](QE(a,n,w))},error:e[r+1],complete:e[r+2]};else{const w=sn(n,Gt);a=sn(w.firestore,ur),u=w._query;const V=new xh(a);o={next:S=>{e[r]&&e[r](new cn(a,V,w,S))},error:e[r+1],complete:e[r+2]},jE(n._query)}const h=Ch(a);return RE(h,u,s,o)}function qh(n,e){const t=Ch(n);return SE(t,e)}function QE(n,e,t){const r=t.docs.get(e._key),s=new xh(n);return new Lt(n,s,e._key,r,new Wn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){vg(gn),un(new xt("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new ur(new Sg(r.getProvider("auth-internal")),new Cg(a,r.getProvider("app-check-internal")),Wg(a,s),a);return o={useFetchStreams:t,...o},u._setSettings(o),u}),"PUBLIC").setMultipleInstances(!0)),ft(lu,hu,e),ft(lu,hu,"esm2020")})();const YE={apiKey:"AIzaSyBrhhpGsDEIH46um9FS2j8uTleOwzPrHZ8",authDomain:"coda-tax.firebaseapp.com",projectId:"coda-tax",storageBucket:"coda-tax.firebasestorage.app",messagingSenderId:"788663710911",appId:"1:788663710911:web:33143712e512d6253c820a",measurementId:"G-LYGK290Y1Z"},jh=Su(YE),Bn=Ig(jh),jr=kE(jh);window.kodaEngine=(()=>{let n={isSubscribed:!1,currentUser:null,records:[],categories:[{id:"수입 합계",keywords:["애드센스","협찬","수입","입금","광고수익","도네","후원","정산"],type:"income",box:"수입"},{id:"식대",keywords:["식대","밥","회식","미팅","커피","편의점","식사"],type:"expense",box:"15"},{id:"여비교통비",keywords:["교통","차비","택시","버스","지하철","주유","기름","톨게이트","주차"],type:"expense",box:"15"},{id:"촬영소품",keywords:["소품","배경","의상","분장","액세서리","가발"],type:"expense",box:"11"},{id:"장비비",keywords:["장비","카메라","마이크","조명","렌즈","컴퓨터","PC","모니터","삼각대"],type:"expense",box:"22"},{id:"소프트웨어/구독",keywords:["구독","툴","프로그램","편집툴","클라우드","어도비","프리미어","라이선스","폰트"],type:"expense",box:"22"},{id:"외주/편집",keywords:["외주","편집","디자인","썸네일","컷편집","제작비"],type:"expense",box:"21"},{id:"통신비",keywords:["통신","인터넷","휴대폰","요금제"],type:"expense",box:"19"},{id:"소모품비",keywords:["소모품","사무용품","펜","종이","문구","건전지"],type:"expense",box:"22"},{id:"수선유지비",keywords:["수선","유지","수리","보수","수리비"],type:"expense",box:"22"},{id:"월세/임차료",keywords:["월세","임대료","임차료","관리비","스튜디오"],type:"expense",box:"13"},{id:"수도광열비",keywords:["수도","전기","가스","난방","냉난방"],type:"expense",box:"18"},{id:"보험료",keywords:["보험","국민연금","건강보험","자동차보험","산재"],type:"expense",box:"15"},{id:"세금과공과",keywords:["세금","면허세","재산세","공과금","범칙금"],type:"expense",box:"20"},{id:"지급수수료",keywords:["수수료","뱅킹수수료","결제수수료","이체수수료"],type:"expense",box:"21"},{id:"기타필요경비",keywords:[],type:"expense",box:"22"}],lastDetected:null,recognition:null,pendingCategory:null,pendingYear:null,isAuthInitialized:!1,portoneId:"imp33124838"};const e=S=>document.getElementById(S),t=S=>new Intl.NumberFormat("ko-KR").format(Math.floor(S)),r=(S,b="success")=>{let P=e("app-toast");P||(P=document.createElement("div"),P.id="app-toast",document.body.appendChild(P)),P.innerText=S,P.className=`toast-visible ${b}`,setTimeout(()=>P.className="",3e3)},s=S=>{window.location.hash=S==="/"?"#/":`#${S}`,o()},o=()=>{const S=window.location.hash||"#/",b=localStorage.getItem("yt_user_status")==="paid",P=e("user-type-overlay"),N=e("app-container");if(!(!P||!N)){if(!n.isAuthInitialized){console.log("Routing deferred - Auth not initialized");return}console.log("Routing Execution - Hash:",S,"User:",n.currentUser?n.currentUser.email:"null","isPaid:",b),S==="#/dashboard"||S.startsWith("#/dashboard")?n.currentUser?(P.style.display="none",N.style.display="flex",d()):b?(console.log("Showing dashboard with 'paid' flag but no user yet"),P.style.display="none",N.style.display="flex",d()):(alert("로그인이 필요합니다. (Routing: redirect to landing)"),console.log("Access denied - Redirecting to landing"),s("/")):n.currentUser?(console.log("Already logged in - Redirecting to dashboard"),s("/dashboard")):(P.style.display="flex",N.style.display="none")}},a=async()=>{alert("세무정석 엔진 시작 (v1018)"),um(Bn,b=>{if(console.log("onAuthStateChanged:",b?b.email:"no user"),n.currentUser=b,n.isAuthInitialized=!0,b){localStorage.setItem("yt_user_status","paid");const P=$E(yi(jr,"users",b.uid,"records"),zE("date","desc"));KE(P,N=>{console.log("Firestore Snapshot received, count:",N.docs.length),n.records=N.docs.map(M=>({id:M.id,...M.data()})),d()},N=>{console.error("Firestore Snapshot Error:",N)})}o()}),window.addEventListener("hashchange",o);const S=window.SpeechRecognition||window.webkitSpeechRecognition;S&&(n.recognition=new S,n.recognition.continuous=!1,n.recognition.interimResults=!0,n.recognition.lang="ko-KR",n.recognition.onresult=b=>{const P=e("voice-transcribed-text"),N=e("voice-result-box"),M=e("voice-status-text");let B="",X="";for(let K=b.resultIndex;K<b.results.length;++K)b.results[K].isFinal?X+=b.results[K][0].transcript:B+=b.results[K][0].transcript;P&&(P.innerText=X||B),X&&(n.lastDetected=h(X),M&&(M.innerText="인식 성공! ✅"),N&&(N.style.display="block"))},n.recognition.onstart=()=>{console.log("Speech Recognition started");const b=e("voice-status-text");b&&(b.innerText="듣고 있습니다... (연결됨)")},n.recognition.onerror=b=>{console.error("Speech Recognition Error:",b.error);const P=e("voice-status-text");P&&(P.innerText="인식 오류: "+b.error),alert("음성 인식 오류: "+b.error+`
(마이크 권한 또는 브라우저 지원 확인 필요)`)},n.recognition.onend=()=>{console.log("Speech Recognition Ended")})},u=S=>{let b=0,P=S.replace(/[\s,]/g,"").replace(/원$/g,"");const N=P.match(/([\d\.]+)\s*억/);N&&(b+=parseFloat(N[1])*1e8);const M=P.match(/([\d\.]+)\s*천만/);M&&(b+=parseFloat(M[1])*1e7);const B=P.match(/([\d\.]+)\s*백만/);B&&(b+=parseFloat(B[1])*1e6);const X=P.match(/([\d\.]+)\s*(?!천만|백만)만/);if(X)b+=parseFloat(X[1])*1e4;else if(!N&&!M&&!B){const K=P.match(/([\d\.]+)\s*만/);K&&(b+=parseFloat(K[1])*1e4)}if(b===0){const K={일:1,이:2,삼:3,사:4,오:5,육:6,칠:7,팔:8,구:9,십:10,백:100,천:1e3,만:1e4,억:1e8},le={십:10,백:100,천:1e3,만:1e4,억:1e8};let T=0,m=0,_=0;for(let I=0;I<P.length;I++){const E=P[I],v=K[E];v!==void 0&&(le[E]?v>=1e4?(T+=(m+(_||1))*v,m=0,_=0):(m+=(_||1)*v,_=0):_=v)}b=T+m+_}if(b===0){const K=P.replace(/[^0-9]/g,"");K&&(b=parseInt(K))}return b},h=S=>{const b=u(S);let P="기타필요경비";const N=S.toLowerCase();for(const X of n.categories)if(X.keywords.some(K=>N.includes(K))){P=X.id;break}const M=new Date;return{date:`${M.getFullYear()}-${(M.getMonth()+1).toString().padStart(2,"0")}-${M.getDate().toString().padStart(2,"0")}`,type:P==="수입 합계"?"income":"expense",category:P,label:S.split(/[0-9]|만|원/)[0].trim()||(b===0?S:P),amount:b,status:"준비"}},d=()=>{if(n.currentUser){const P=e("user-status-indicator"),N=e("logged-in-user-id");P&&(P.style.display="block"),N&&(N.innerText=n.currentUser.email.split("@")[0])}else{const P=e("user-status-indicator");P&&(P.style.display="none")}const S=e("history-list-mvp");if(!S)return;const b=n.records.slice(0,10);b.length===0?S.innerHTML='<tr><td colspan="5" class="empty-row">기록이 없습니다.</td></tr>':S.innerHTML=b.map(P=>`
                <tr>
            ...
            `).join("")};return{init:a,requestKakaoPay:()=>{const{IMP:S}=window;if(!S){alert("결제 모듈 로드 중입니다.");return}S.init(n.portoneId),S.request_pay({pg:"kakaopay.TC0ONETIME",pay_method:"card",merchant_uid:"merchant_"+new Date().getTime(),name:"세무정석 프리미엄 멤버십",amount:5900,buyer_email:"test@example.com",buyer_name:"테스트유저",buyer_tel:"010-1234-5678"},b=>{b.success?(e("payment-view-initial").style.display="none",e("payment-view-success").style.display="block"):alert("결제에 실패했습니다: "+b.error_msg)})},finalizeSignUp:async S=>{S&&S.preventDefault();const b=e("reg-id").value.trim(),P=e("reg-pw").value.trim(),N=e("reg-submit-btn");if(!b||!P){alert("아이디와 비밀번호를 모두 입력해주세요.");return}N&&(N.disabled=!0,N.innerText="결제 및 가입 처리 중...",N.style.opacity="0.7");try{const M=b.includes("@")?b:`${b}@coda-tax.com`;await im(Bn,M,P),e("payment-view-success").style.display="none",e("payment-view-final-success").style.display="block",localStorage.setItem("yt_user_status","paid")}catch(M){N&&(N.disabled=!1,N.innerText="시작하기",N.style.opacity="1"),console.error("Auth Error Detail:",M.code,M.message);let B="가입 오류가 발생했습니다. ";M.code==="auth/configuration-not-found"?B="Firebase 설정 오류: 'Email/Password' 인증을 활성화해 주세요.":M.code==="auth/email-already-in-use"?B="이미 존재하는 아이디입니다.":M.code==="auth/weak-password"?B="비밀번호는 6자리 이상이어야 합니다.":M.code==="auth/invalid-email"&&(B="아이디 형식이 올바르지 않습니다."),alert("⚠️ "+B)}},login:async S=>{S&&S.preventDefault();const b=e("login-id").value.trim(),P=e("login-pw").value.trim();if(!(!b||!P))try{const N=b.includes("@")?b:`${b}@coda-tax.com`,M=await om(Bn,N,P);alert("로그인 성공! (UID: "+M.user.uid.slice(0,5)+")"),n.currentUser=M.user,n.isAuthInitialized=!0,localStorage.setItem("yt_user_status","paid"),s("/dashboard")}catch(N){console.error("Login Error:",N),alert("로그인 오류: "+N.message)}},logout:async()=>{if(confirm("로그아웃 하시겠습니까?"))try{await lm(Bn),localStorage.removeItem("yt_user_status"),window.location.href=window.location.pathname+"#/",window.location.reload()}catch(S){console.error("Logout error:",S),alert("로그아웃 중 오류가 발생했습니다.")}},navigate:s,tryStartService:()=>{e("payment-view-initial").style.display="block",e("payment-view-success").style.display="none",e("payment-view-final-success").style.display="none",e("payment-modal").style.display="flex"},startVoiceRecord:()=>{console.log("startVoiceRecord clicked"),location.protocol!=="https:"&&location.hostname!=="localhost"&&alert(`⚠️ 음성 기록은 보안 연결(HTTPS)에서만 작동합니다.
현재: `+location.protocol);const S=e("voice-modal");if(!S){alert("오류: 음성 모달 요소를 찾을 수 없습니다.");return}e("voice-transcribed-text").innerText="",e("voice-result-box").style.display="none",e("voice-status-text").innerText="마이크 초기화 중...",S.style.display="flex";const b=window.SpeechRecognition||window.webkitSpeechRecognition;if(!n.recognition&&b&&(console.log("Lazy initializing SpeechRecognition..."),n.recognition=new b,n.recognition.continuous=!1,n.recognition.interimResults=!0,n.recognition.lang="ko-KR",n.recognition.onresult=P=>{let N="",M="";for(let B=P.resultIndex;B<P.results.length;++B)P.results[B].isFinal?M+=P.results[B][0].transcript:N+=P.results[B][0].transcript;e("voice-transcribed-text").innerText=M||N,M&&(n.lastDetected=h(M),e("voice-status-text").innerText="인식 성공! ✅",e("voice-result-box").style.display="block")},n.recognition.onerror=P=>alert("인식 오류: "+P.error)),n.recognition)try{console.log("Calling recognition.start()..."),n.recognition.start()}catch(P){console.error("Recognition Start Error:",P),P.name==="InvalidStateError"?(console.log("InvalidStateError: Attempting restart..."),n.recognition.stop(),setTimeout(()=>n.recognition.start(),100)):alert("마이크 시작 오류: "+P.message)}else alert("이 브라우저나 기기에서는 음성 인식을 지원하지 않습니다.")},confirmVoiceEntry:async()=>{if(!n.lastDetected){alert("인식된 내용이 없습니다.");return}if(!n.currentUser){alert("로그인 정보가 없습니다. 다시 로그인해 주세요."),s("/");return}const S=document.querySelector("#voice-result-box .btn-primary");S&&(S.disabled=!0,S.innerText="저장 중...");try{console.log("Firestore Save Start:",n.lastDetected);const b=await mu(yi(jr,"users",n.currentUser.uid,"records"),n.lastDetected);console.log("Firestore Save Success - ID:",b.id),alert("기록 저장 완료! ✅"),r("내역이 저장되었습니다! 🎉"),e("voice-modal").style.display="none",n.lastDetected=null,S&&(S.disabled=!1,S.innerText="저장하기")}catch(b){console.error("Firestore Save Error:",b),alert("저장 실패 오류: "+b.message+`
(데이터베이스 권한 또는 연결 상태를 확인해주세요)`),r("저장 실패: 권한 또는 연결 오류","error"),S&&(S.disabled=!1,S.innerText="저장하기")}},cancelVoiceModal:()=>{n.lastDetected=null,e("voice-modal").style.display="none",e("voice-transcribed-text").innerText="",e("voice-result-box").style.display="none",e("voice-status-text").innerText="듣고 있습니다..."},clearVoiceTranscript:()=>{n.recognition&&n.recognition.start()},openAddModal:()=>e("edit-modal").style.display="flex",saveManualEntry:async S=>{if(S&&S.preventDefault(),!n.currentUser){alert("로그인 정보가 없습니다."),s("/");return}const b={date:e("edit-date").value||new Date().toISOString().split("T")[0],type:e("edit-type").value,category:e("edit-category").value,amount:parseInt(e("edit-amount").value)||0,status:"준비"};try{await mu(yi(jr,"users",n.currentUser.uid,"records"),b),alert("내역이 수동으로 저장되었습니다."),e("edit-modal").style.display="none"}catch(P){console.error("Manual Save Error:",P),alert("수동 저장 실패: "+P.message)}},deleteRecord:async S=>{confirm("정말 삭제하시겠습니까?")&&await GE(bh(jr,"users",n.currentUser.uid,"records",S))},showYearlyCategorySummary:()=>alert("상세 리포트 준비중입니다."),showPrevYearSummary:()=>alert("전년도 세무 리포트 준비중입니다."),openHometax:()=>window.open("https://www.hometax.go.kr","_blank"),loginWithGoogle:async()=>{try{const S=new He,b=await km(Bn,S);b.user&&(n.currentUser=b.user,n.isAuthInitialized=!0,localStorage.setItem("yt_user_status","paid"),console.log("Google Login success - Redirecting..."),s("/dashboard"))}catch(S){console.error("Google Login Error Details:",S);let b="구글 로그인 중 오류가 발생했습니다.";switch(S.code){case"auth/popup-blocked":b="⚠️ 브라우저 팝업이 차단되었습니다. 주소창 옆의 팝업 허용 버튼을 눌러주세요.";break;case"auth/popup-closed-by-user":return;case"auth/cancelled-popup-request":return;case"auth/unauthorized-domain":b="⚠️ 현재 도메인이 승인되지 않았습니다. Firebase 콘솔에서 도메인을 추가해주세요.";break;case"auth/network-request-failed":b="⚠️ 네트워크 연결이 불안정합니다. 인터넷 연결을 확인해주세요.";break;case"auth/internal-error":b="⚠️ 서버 내부 오류가 발생했습니다. 잠시 후 다시 시도해주세요.";break;default:b+=`
코드: ${S.code}
메시지: ${S.message}`}alert(b)}}}})();window.addEventListener("DOMContentLoaded",()=>{window.kodaEngine.init().catch(console.error)});
