 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kf="firebase-heartbeat-database",Qf=1,Zn="firebase-heartbeat-store";let li=null;function Su(){return li||(li=df(Kf,Qf,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Zn)}catch(t){console.warn(t)}}}}).catch(n=>{throw dt.create("idb-open",{originalErrorMessage:n.message})})),li}async function Yf(n){try{const t=(await Su()).transaction(Zn),r=await t.objectStore(Zn).get(Pu(n));return await t.done,r}catch(e){if(e instanceof Xe)Ke.warn(e.message);else{const t=dt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ke.warn(t.message)}}}async function za(n,e){try{const r=(await Su()).transaction(Zn,"readwrite");await r.objectStore(Zn).put(e,Pu(n)),await r.done}catch(t){if(t instanceof Xe)Ke.warn(t.message);else{const r=dt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Ke.warn(r.message)}}}function Pu(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ft(sp,ip,"app");function Cu(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const op=Cu,bu=new lr("auth","Firebase",Cu());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ne(n,...e){throw Ki(n,...e)}function Fe(n,...e){return Ki(n,...e)}function ku(n,e,t){const r={...op(),[e]:t};return new lr("auth","Firebase",r).create(e,{appName:n.name})}function Ge(n){return ku(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Ki(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return bu.create(n,...e)}function M(n,e,...t){if(!n)throw Ki(e,...t)}function He(n){const e="INTERNAL ASSERTION FAILED: "+n;throw $r(e),new Error(e)}function Qe(n,e){n||He(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dr{constructor(e,t){this.shortDelay=e,this.longDelay=t,Qe(t>e,"Short delay should be less than long delay!"),this.isMobile=Nd()||xd()}get(){return up()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function rs(n){var E;const e=n.auth,t=await n.getIdToken(),r=await er(n,ns(e,{idToken:t}));M(r==null?void 0:r.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const o=(E=s.providerUserInfo)!=null&&E.length?Ou(s.providerUserInfo):[],a=vp(n.providerData,o),u=n.isAnonymous,h=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),d=u?h:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new Ri(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function wp(n){const e=Te(n);await rs(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function vp(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Ou(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qp(n,e){const t=Gi(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),o=t.getOptions();if(Ot(o,e??{}))return s;Ne(s,"already-initialized")}return t.initialize({options:e})}function jp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(We);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function $p(n,e,t){const r=qt(n);M(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,o=Gu(e),{host:a,port:u}=zp(e),h=u===null?"":`:${u}`,d={url:`${o}//${a}${h}/`},p=Object.freeze({host:a,port:u,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){M(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),M(Ot(d,r.config.emulator)&&Ot(p,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=d,r.emulatorConfig=p,r.settings.appVerificationDisabledForTesting=!0,mn(a)?(Tu(`${o}//${a}${h}`),Iu("Auth",!0)):Hp()}function Gu(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function zp(n){const e=Gu(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const o=s[1];return{host:o,port:tc(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:tc(a)}}}function tc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Hp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gp(n,e){return fr(n,"POST","/v1/accounts:signInWithPassword",wt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kp(n,e){return fr(n,"POST","/v1/accounts:signInWithEmailLink",wt(n,e))}async function Qp(n,e){return fr(n,"POST","/v1/accounts:signInWithEmailLink",wt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jp(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Xp(n){const e=qn(jn(n)).link,t=e?qn(jn(e)).deep_link_id:null,r=qn(jn(n)).deep_link_id;return(r?qn(jn(r)).link:null)||r||t||e||n}class Zi{constructor(e){const t=qn(jn(e)),r=t.apiKey??null,s=t.oobCode??null,o=Jp(t.mode??null);M(r&&s&&o,"argument-error"),this.apiKey=r,this.operation=o,this.code=s,this.continueUrl=t.continueUrl??null,this.languageCode=t.lang??null,this.tenantId=t.tenantId??null}static parseLink(e){const t=Xp(e);try{return new Zi(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pr extends Ku{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zp(n,e){return fr(n,"POST","/v1/accounts:signUp",wt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ag="__/auth/handler",cg="emulator/auth/handler",ug=encodeURIComponent("fac");async function cc(n,e,t,r,s,o){M(n.config.authDomain,n,"auth-domain-config-required"),M(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:gn,eventId:s};if(e instanceof Ku){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",Hd(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[p,E]of Object.entries({}))a[p]=E}if(e instanceof pr){const p=e.getScopes().filter(E=>E!=="");p.length>0&&(a.scopes=p.join(","))}n.tenantId&&(a.tid=n.tenantId);const u=a;for(const p of Object.keys(u))u[p]===void 0&&delete u[p];const h=await n._getAppCheckToken(),d=h?`#${ug}=${encodeURIComponent(h)}`:"";return`${lg(n)}?${hr(u).slice(1)}${d}`}function lg({config:n}){return n.emulator?Qi(n,cg):`https://${n.authDomain}/${ag}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function x(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,pl(n,r,t)}function pl(n,e,t){let r=`FIRESTORE (${yn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw Ye(r),new Error(r)}function K(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||pl(e,s,r)}function q(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Il="server_timestamp",wl="__type__",vl="__previous_value__",Al="__local_write_time__";function io(n){var t,r;return((r=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[wl])==null?void 0:r.stringValue)===Il}function Rs(n){const e=n.mapValue.fields[vl];return io(e)?Rs(e):e}function rr(n){const e=_t(n.mapValue.fields[Al].timestampValue);return new X(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $g{constructor(e,t,r,s,o,a,u,h,d,p,E){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=o,this.forceLongPolling=a,this.autoDetectLongPolling=u,this.longPollingOptions=h,this.useFetchStreams=d,this.isUsingEmulator=p,this.apiKey=E}}const cs="(default)";class sr{constructor(e,t){this.projectId=e,this.database=t||cs}static empty(){return new sr("","")}get isDefaultDatabase(){return this.database===cs}isEqual(e){return e instanceof sr&&e.projectId===this.projectId&&e.database===this.database}}function zg(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new N(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new sr(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ce{constructor(e){this.value=e}static empty(){return new Ce({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!Qr(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Qn(t)}setAll(e){let t=he.emptyPath(),r={},s=[];e.forEach(((a,u)=>{if(!t.isImmediateParentOf(u)){const h=this.getFieldsMap(t);this.applyChanges(h,r,s),r={},s=[],t=u.popLast()}a?r[u.lastSegment()]=Qn(a):s.push(u.lastSegment())}));const o=this.getFieldsMap(t);this.applyChanges(o,r,s)}delete(e){const t=this.field(e.popLast());Qr(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return ze(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];Qr(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){jt(t,((s,o)=>e[s]=o));for(const s of r)delete e[s]}clone(){return new Ce(Qn(this.value))}}function Pl(n){const e=[];return jt(n.fields,((t,r)=>{const s=new he([t]);if(Qr(r)){const o=Pl(r.mapValue).fields;if(o.length===0)e.push(s);else for(const a of o)e.push(s.child(a))}else e.push(s)})),new Ve(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ks{constructor(e,t,r,s,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,yr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new ks(U.min(),s,new Z(H),Je(),W())}}class yr{constructor(e,t,r,s,o){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new yr(r,t,W(),W(),W())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ge="WebChannelConnection",Un=(n,e,t)=>{n.listen(e,(r=>{try{t(r)}catch(s){setTimeout((()=>{throw s}),0)}}))};class on extends Py{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!on.c_){const e=dl();Un(e,hl.STAT_EVENT,(t=>{t.stat===Ci.PROXY?O(ge,"STAT_EVENT: detected buffering proxy"):t.stat===Ci.NOPROXY&&O(ge,"STAT_EVENT: detected no buffering proxy")})),on.c_=!0}}zo(e,t,r,s,o){const a=qi();return new Promise(((u,h)=>{const d=new ul;d.setWithCredentials(!0),d.listenOnce(ll.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case Gr.NO_ERROR:const E=d.getResponseJson();O(ge,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(E)),u(E);break;case Gr.TIMEOUT:O(ge,`RPC '${e}' ${a} timed out`),h(new N(P.DEADLINE_EXCEEDED,"Request time out"));break;case Gr.HTTP_ERROR:const _=d.getStatus();if(O(ge,`RPC '${e}' ${a} failed with status:`,_,"response text:",d.getResponseText()),_>0){let R=d.getResponseJson();Array.isArray(R)&&(R=R[0]);const b=R==null?void 0:R.error;if(b&&b.status&&b.message){const k=(function(B){const F=B.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(F)>=0?F:P.UNKNOWN})(b.status);h(new N(k,b.message))}else h(new N(P.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new N(P.UNAVAILABLE,"Connection failed."));break;default:x(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{O(ge,`RPC '${e}' ${a} completed.`)}}));const p=JSON.stringify(s);O(ge,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",p,r,15)}))}T_(e,t,r){const s=qi(),o=[this.qo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Go(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const d=o.join("");O(ge,`Creating RPC '${e}' stream ${s}: ${d}`,u);const p=a.createWebChannel(d,u);this.I_(p);let E=!1,_=!1;const R=new Cy({Ho:b=>{_?O(ge,`Not sending because RPC '${e}' stream ${s} is closed:`,b):(E||(O(ge,`Opening RPC '${e}' stream ${s} transport.`),p.open(),E=!0),O(ge,`RPC '${e}' stream ${s} sending:`,b),p.send(b))},Jo:()=>p.close()});return Un(p,$n.EventType.OPEN,(()=>{_||(O(ge,`RPC '${e}' stream ${s} transport opened.`),R.i_())})),Un(p,$n.EventType.CLOSE,(()=>{_||(_=!0,O(ge,`RPC '${e}' stream ${s} transport closed`),R.o_(),this.E_(p))})),Un(p,$n.EventType.ERROR,(b=>{_||(_=!0,Ut(ge,`RPC '${e}' stream ${s} transport errored. Name:`,b.name,"Message:",b.message),R.o_(new N(P.UNAVAILABLE,"The operation could not be completed")))})),Un(p,$n.EventType.MESSAGE,(b=>{var k;if(!_){const V=b.data[0];K(!!V,16349);const B=V,F=(B==null?void 0:B.error)||((k=B[0])==null?void 0:k.error);if(F){O(ge,`RPC '${e}' stream ${s} received error:`,F);const j=F.status;let ve=(function(I){const m=ne[I];if(m!==void 0)return Gl(m)})(j),fe=F.message;j==="NOT_FOUND"&&fe.includes("database")&&fe.includes("does not exist")&&fe.includes(this.databaseId.database)&&Ut(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),ve===void 0&&(ve=P.INTERNAL,fe="Unknown error status: "+j+" with message "+F.message),_=!0,R.o_(new N(ve,fe)),p.close()}else O(ge,`RPC '${e}' stream ${s} received:`,V),R.__(V)}})),on.u_(),setTimeout((()=>{R.s_()}),0),R}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}I_(e){this.a_.push(e)}E_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,r){super.Go(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return fl()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $e{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new N(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new N(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return H(this._lat,e._lat)||H(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:$e._jsonSchemaVersion}}static fromJSON(e){if(gr(e,$e._jsonSchema))return new $e(e.latitude,e.longitude)}}$e._jsonSchemaVersion="firestore/geoPoint/1.0",$e._jsonSchema={type:se("string",$e._jsonSchemaVersion),latitude:se("number"),longitude:se("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class De{constructor(e){this._values=(e||[]).map((t=>t))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(r,s){if(r.length!==s.length)return!1;for(let o=0;o<r.length;++o)if(r[o]!==s[o])return!1;return!0})(this._values,e._values)}toJSON(){return{type:De._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(gr(e,De._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((t=>typeof t=="number")))return new De(e.vectorValues);throw new N(P.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}De._jsonSchemaVersion="firestore/vectorValue/1.0",De._jsonSchema={type:se("string",De._jsonSchemaVersion),vectorValues:se("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */cn._jsonSchemaVersion="firestore/querySnapshot/1.0",cn._jsonSchema={type:se("string",cn._jsonSchemaVersion),bundleSource:se("string","QuerySnapshot"),bundleName:se("string"),bundle:se("string")};function HE(n){return Bh(sn(n.firestore,ur),[new ho(n._key,qe.none())])}function fu(n,e){const t=sn(n.firestore,ur),r=Ph(n),s=$E(n.converter,e),o=Dh(n.firestore);return Bh(t,[NE(o,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,qe.exists(!1))]).then((()=>r))}function WE(n,...e){var d,p,E;n=Te(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||lu(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(lu(e[r])){const _=e[r];e[r]=(d=_.next)==null?void 0:d.bind(_),e[r+1]=(p=_.error)==null?void 0:p.bind(_),e[r+2]=(E=_.complete)==null?void 0:E.bind(_)}let o,a,u;if(n instanceof oe)a=sn(n.firestore,ur),u=uo(n._key.path),o={next:_=>{e[r]&&e[r](GE(a,n,_))},error:e[r+1],complete:e[r+2]};else{const _=sn(n,Wt);a=sn(_.firestore,ur),u=_._query;const R=new Mh(a);o={next:b=>{e[r]&&e[r](new cn(a,R,_,b))},error:e[r+1],complete:e[r+2]},BE(n._query)}const h=Ch(a);return vE(h,u,s,o)}function Bh(n,e){const t=Ch(n);return AE(t,e)}function GE(n,e,t){const r=t.docs.get(e._key),s=new Mh(n);return new Nt(n,s,e._key,r,new Wn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){Ig(gn),un(new Lt("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new ur(new Ag(r.getProvider("auth-internal")),new Pg(a,r.getProvider("app-check-internal")),zg(a,s),a);return o={useFetchStreams:t,...o},u._setSettings(o),u}),"PUBLIC").setMultipleInstances(!0)),ft(cu,uu,e),ft(cu,uu,"esm2020")})();const KE={apiKey:"AIzaSyBrhhpGsDEIH46um9FS2j8uTleOwzPrHZ8",authDomain:"coda-tax.firebaseapp.com",projectId:"coda-tax",storageBucket:"coda-tax.firebasestorage.app",messagingSenderId:"788663710911",appId:"1:788663710911:web:33143712e512d6253c820a",measurementId:"G-LYGK290Y1Z"},qh=Au(KE),Bn=Eg(qh),jr=CE(qh);window.kodaEngine=(()=>{let n={isSubscribed:!1,currentUser:null,records:[],categories:[{id:"수입 합계",keywords:["애드센스","협찬","수입","입금","광고수익","도네","후원"],type:"income",box:"수입"},{id:"식대",keywords:["식대","밥","회식","미팅","커피"],type:"expense",box:"15"},{id:"여비교통비",keywords:["교통","차비","택시","버스","지하철","주유","기름"],type:"expense",box:"15"},{id:"촬영소품",keywords:["소품","배경","의상","분장"],type:"expense",box:"11"},{id:"장비비",keywords:["장비","카메라","마이크","조명","렌즈","컴퓨터","PC"],type:"expense",box:"22"},{id:"소프트웨어/구독",keywords:["구독","툴","프로그램","편집툴","클라우드","어도비","프리미어","라이선스"],type:"expense",box:"22"},{id:"외주/편집",keywords:["외주","편집","디자인","썸네일","컷편집"],type:"expense",box:"21"},{id:"통신비",keywords:["통신","인터넷","휴대폰"],type:"expense",box:"19"},{id:"소모품비",keywords:["소모품","사무용품","펜","종이","문구"],type:"expense",box:"22"},{id:"수선유지비",keywords:["수선","유지","수리","보수"],type:"expense",box:"22"},{id:"월세/임차료",keywords:["월세","임대료","임차료","관리비"],type:"expense",box:"13"},{id:"수도광열비",keywords:["수도","전기","가스","난방"],type:"expense",box:"18"},{id:"보험료",keywords:["보험","국민연금","건강보험","자동차보험"],type:"expense",box:"15"},{id:"세금과공과",keywords:["세금","면허세","재산세","공과금"],type:"expense",box:"20"},{id:"지급수수료",keywords:["수수료","뱅킹수수료","결제수수료"],type:"expense",box:"21"},{id:"기타필요경비",keywords:[],type:"expense",box:"22"}],lastDetected:null,recognition:null,pendingCategory:null,pendingYear:null};const e=_=>document.getElementById(_),t=_=>new Intl.NumberFormat("ko-KR").format(Math.floor(_)),r=_=>{window.location.hash=_==="/"?"#/":`#${_}`,s()},s=()=>{const _=window.location.hash||"#/",R=localStorage.getItem("yt_user_status")==="paid",b=e("user-type-overlay"),k=e("app-container");if(!(!b||!k))if(_==="#/dashboard"||_.startsWith("#/dashboard")){if(!n.currentUser&&!R){r("/");return}b.style.display="none",k.style.display="flex",h()}else b.style.display="flex",k.style.display="none"},o=()=>{am(Bn,R=>{if(R){n.currentUser=R,localStorage.setItem("yt_user_status","paid");const b=qE(yi(jr,"users",R.uid,"records"),jE("date","desc"));WE(b,k=>{n.records=k.docs.map(V=>({id:V.id,...V.data()})),h()}),window.location.hash==="#/"&&r("/dashboard")}else n.currentUser=null,localStorage.removeItem("yt_user_status"),r("/"),h()}),s(),window.addEventListener("hashchange",s);const _=window.SpeechRecognition||window.webkitSpeechRecognition;_&&(n.recognition=new _,n.recognition.continuous=!1,n.recognition.interimResults=!0,n.recognition.lang="ko-KR",n.recognition.onresult=R=>{const b=e("voice-transcribed-text"),k=e("voice-result-box"),V=e("voice-status-text");let B="",F="";for(let j=R.resultIndex;j<R.results.length;++j)R.results[j].isFinal?F+=R.results[j][0].transcript:B+=R.results[j][0].transcript;b&&(b.innerText=F||B),F&&(n.lastDetected=u(F),V&&(V.innerText="인식 성공! ✅"),k&&(k.style.display="block"))})},a=_=>{let R=0,b=_.replace(/[\s,]/g,"").replace(/원$/g,"");const k=b.match(/([\d\.]+)\s*억/);k&&(R+=parseFloat(k[1])*1e8);const V=b.match(/([\d\.]+)\s*천만/);V&&(R+=parseFloat(V[1])*1e7);const B=b.match(/([\d\.]+)\s*백만/);B&&(R+=parseFloat(B[1])*1e6);const F=b.match(/([\d\.]+)\s*(?!천만|백만)만/);if(F)R+=parseFloat(F[1])*1e4;else if(!k&&!V&&!B){const j=b.match(/([\d\.]+)\s*만/);j&&(R+=parseFloat(j[1])*1e4)}if(R===0){const j=b.replace(/[^0-9]/g,"");j&&(R=parseInt(j))}return R},u=_=>{const R=a(_);let b="기타필요경비";const k=_.toLowerCase();for(const F of n.categories)if(F.keywords.some(j=>k.includes(j))){b=F.id;break}const V=new Date;return{date:`${V.getFullYear()}-${(V.getMonth()+1).toString().padStart(2,"0")}-${V.getDate().toString().padStart(2,"0")}`,type:b==="수입 합계"?"income":"expense",category:b,label:_.split(/[0-9]|만|원/)[0].trim()||b,amount:R,status:"준비"}},h=()=>{const _=e("history-list-mvp");if(!_)return;const R=n.records.slice(0,10);R.length===0?_.innerHTML='<tr><td colspan="5" class="empty-row">기록이 없습니다.</td></tr>':_.innerHTML=R.map(b=>`
                <tr>
            ...
            `).join("")},d=()=>{const _=["k-c1-v999","k-c2-v999","k-c3-v999","k-c4-v999","k-em-v999","k-ey-v999","k-cv-v999","k-p2-v999"];_.forEach((R,b)=>{const k=e(R);k&&(k.addEventListener("input",V=>{let B=V.target.value.replace(/\D/g,"");V.target.value=B,B.length>=V.target.maxLength&&_[b+1]&&e(_[b+1]).focus()}),k.addEventListener("keydown",V=>{V.key==="Backspace"&&!V.target.value&&_[b-1]&&e(_[b-1]).focus()}))})};return{init:o,startVoiceRecord:()=>{e("voice-transcribed-text").innerText="",e("voice-result-box").style.display="none",e("voice-modal").style.display="flex",n.recognition&&n.recognition.start()},clearVoiceTranscript:()=>{n.recognition&&n.recognition.start()},confirmVoiceEntry:async()=>{if(!(!n.lastDetected||!n.currentUser))try{await fu(yi(jr,"users",n.currentUser.uid,"records"),n.lastDetected),e("voice-modal").style.display="none",n.lastDetected=null}catch{alert("저장 실패")}},deleteRecord:async _=>{confirm("정말 삭제하시겠습니까?")&&await HE(Ph(jr,"users",n.currentUser.uid,"records",_))},showCardInput:()=>{e("payment-view-initial").style.display="none",e("payment-view-card").style.display="block",d()},confirmSubscription:()=>{e("payment-view-card").style.display="none",e("payment-view-success").style.display="block"},finalizeSignUp:async _=>{_&&_.preventDefault();const R=e("reg-id").value.trim(),b=e("reg-pw").value.trim();if(!R||!b){alert("아이디/비번을 입력해주세요.");return}console.log("Starting Firebase check...",Bn.app.options.projectId);try{const k=R.includes("@")?R:`${R}@coda-tax.com`,V=await rm(Bn,k,b);console.log("Success:",V.user.uid),alert("환영합니다! 가입이 완료되었습니다."),e("payment-modal").style.display="none",r("/dashboard")}catch(k){console.error("Auth Error Detail:",k.code,k.message),k.code==="auth/configuration-not-found"?alert("Firebase 인증 설정 오류입니다. 관리자에게 문의해주세요. (Email/Password provider missing)"):alert("가입 오류: "+k.message)}},login:async _=>{_&&_.preventDefault();const R=e("login-id").value.trim(),b=e("login-pw").value.trim();if(!(!R||!b))try{const k=R.includes("@")?R:`${R}@coda-tax.com`;await sm(Bn,k,b),r("/dashboard")}catch{alert("아이디 또는 비밀번호가 틀렸습니다.")}},logout:()=>cm(Bn),tryStartService:()=>{e("payment-view-initial").style.display="block",e("payment-view-card").style.display="none",e("payment-view-success").style.display="none",e("payment-modal").style.display="flex"},openAddModal:()=>e("edit-modal").style.display="flex",saveManualEntry:async _=>{_.preventDefault();const R={date:e("edit-date").value||new Date().toISOString().split("T")[0],type:e("edit-type").value,category:e("edit-category").value,amount:parseInt(e("edit-amount").value)||0,status:"준비"};await fu(yi(jr,"users",n.currentUser.uid,"records"),R),e("edit-modal").style.display="none"},showYearlyCategorySummary:()=>alert("상세 리포트 준비중입니다."),showPrevYearSummary:()=>alert("전년도 세무 리포트 준비중입니다."),openHometax:()=>window.open("https://www.hometax.go.kr","_blank"),navigate:r}})();
