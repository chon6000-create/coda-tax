 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qd="FirebaseError";class Xe extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=qd,Object.setPrototypeOf(this,Xe.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,ur.prototype.create)}}class ur{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,o=this.errors[e],a=o?jd(o,r):"Error",u=`${this.serviceName}: ${a} (${s}).`;return new Xe(s,u,r)}}function jd(n,e){return n.replace($d,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const $d=/\{\$([^}]+)}/g;function zd(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function Ot(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const o=n[s],a=e[s];if(Fa(o)&&Fa(a)){if(!Ot(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function Fa(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */dt(rp,sp,"app");function Cu(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const ip=Cu,ku=new ur("auth","Firebase",Cu());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hr{constructor(e,t){this.shortDelay=e,this.longDelay=t,Qe(t>e,"Short delay should be less than long delay!"),this.isMobile=Dd()||Md()}get(){return up()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ts(n){var m;const e=n.auth,t=await n.getIdToken(),r=await Zn(n,es(e,{idToken:t}));M(r==null?void 0:r.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const o=(m=s.providerUserInfo)!=null&&m.length?Ou(s.providerUserInfo):[],a=vp(n.providerData,o),u=n.isAnonymous,h=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),d=u?h:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new Ai(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function wp(n){const e=Te(n);await ts(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function vp(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Ou(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _n{constructor(){this.providerId=_n.PROVIDER_ID}static credential(e,t){return er._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=Xi.parseLink(t);return M(r,"argument-error"),er._fromEmailAndCode(e,r.code,r.tenantId)}}_n.PROVIDER_ID="password";_n.EMAIL_PASSWORD_SIGN_IN_METHOD="password";_n.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tl="server_timestamp",Il="__type__",wl="__previous_value__",vl="__local_write_time__";function io(n){var t,r;return((r=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[Il])==null?void 0:r.stringValue)===Tl}function As(n){const e=n.mapValue.fields[wl];return io(e)?As(e):e}function nr(n){const e=_t(n.mapValue.fields[vl].timestampValue);return new X(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jg{constructor(e,t,r,s,o,a,u,h,d,p,m){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=o,this.forceLongPolling=a,this.autoDetectLongPolling=u,this.longPollingOptions=h,this.useFetchStreams=d,this.isUsingEmulator=p,this.apiKey=m}}const os="(default)";class rr{constructor(e,t){this.projectId=e,this.database=t||os}static empty(){return new rr("","")}get isDefaultDatabase(){return this.database===os}isEqual(e){return e instanceof rr&&e.projectId===this.projectId&&e.database===this.database}}function $g(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new N(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new rr(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class be{constructor(e){this.value=e}static empty(){return new be({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!Gr(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Kn(t)}setAll(e){let t=he.emptyPath(),r={},s=[];e.forEach(((a,u)=>{if(!t.isImmediateParentOf(u)){const h=this.getFieldsMap(t);this.applyChanges(h,r,s),r={},s=[],t=u.popLast()}a?r[u.lastSegment()]=Kn(a):s.push(u.lastSegment())}));const o=this.getFieldsMap(t);this.applyChanges(o,r,s)}delete(e){const t=this.field(e.popLast());Gr(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return ze(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];Gr(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){jt(t,((s,o)=>e[s]=o));for(const s of r)delete e[s]}clone(){return new be(Kn(this.value))}}function Sl(n){const e=[];return jt(n.fields,((t,r)=>{const s=new he([t]);if(Gr(r)){const o=Sl(r.mapValue).fields;if(o.length===0)e.push(s);else for(const a of o)e.push(s.child(a))}else e.push(s)})),new De(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cs{constructor(e,t,r,s,o){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,gr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Cs(F.min(),s,new Z(z),Je(),H())}}class gr{constructor(e,t,r,s,o){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new gr(r,t,H(),H(),H())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $e{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new N(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new N(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return z(this._lat,e._lat)||z(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:$e._jsonSchemaVersion}}static fromJSON(e){if(pr(e,$e._jsonSchema))return new $e(e.latitude,e.longitude)}}$e._jsonSchemaVersion="firestore/geoPoint/1.0",$e._jsonSchema={type:se("string",$e._jsonSchemaVersion),latitude:se("number"),longitude:se("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oe{constructor(e){this._values=(e||[]).map((t=>t))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(r,s){if(r.length!==s.length)return!1;for(let o=0;o<r.length;++o)if(r[o]!==s[o])return!1;return!0})(this._values,e._values)}toJSON(){return{type:Oe._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(pr(e,Oe._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((t=>typeof t=="number")))return new Oe(e.vectorValues);throw new N(P.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Oe._jsonSchemaVersion="firestore/vectorValue/1.0",Oe._jsonSchema={type:se("string",Oe._jsonSchemaVersion),vectorValues:se("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */an._jsonSchemaVersion="firestore/querySnapshot/1.0",an._jsonSchema={type:se("string",an._jsonSchemaVersion),bundleSource:se("string","QuerySnapshot"),bundleName:se("string"),bundle:se("string")};function zE(n){return Uh(rn(n.firestore,cr),[new ho(n._key,qe.none())])}function HE(n,e){const t=rn(n.firestore,cr),r=Sh(n),s=jE(n.converter,e),o=Vh(n.firestore);return Uh(t,[DE(o,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,qe.exists(!1))]).then((()=>r))}function WE(n,...e){var d,p,m;n=Te(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||du(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(du(e[r])){const E=e[r];e[r]=(d=E.next)==null?void 0:d.bind(E),e[r+1]=(p=E.error)==null?void 0:p.bind(E),e[r+2]=(m=E.complete)==null?void 0:m.bind(E)}let o,a,u;if(n instanceof oe)a=rn(n.firestore,cr),u=uo(n._key.path),o={next:E=>{e[r]&&e[r](GE(a,n,E))},error:e[r+1],complete:e[r+2]};else{const E=rn(n,Wt);a=rn(E.firestore,cr),u=E._query;const A=new Lh(a);o={next:C=>{e[r]&&e[r](new an(a,A,E,C))},error:e[r+1],complete:e[r+2]},UE(n._query)}const h=Ph(a);return wE(h,u,s,o)}function Uh(n,e){const t=Ph(n);return vE(t,e)}function GE(n,e,t){const r=t.docs.get(e._key),s=new Lh(n);return new Nt(n,s,e._key,r,new Hn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){Tg(gn),cn(new Lt("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new cr(new vg(r.getProvider("auth-internal")),new Sg(a,r.getProvider("app-check-internal")),$g(a,s),a);return o={useFetchStreams:t,...o},u._setSettings(o),u}),"PUBLIC").setMultipleInstances(!0)),dt(lu,hu,e),dt(lu,hu,"esm2020")})();const KE={apiKey:"AIzaSyBrhhpGsDEIH46um9FS2j8uTleOwzPrHZ8",authDomain:"coda-tax.firebaseapp.com",projectId:"coda-tax",storageBucket:"coda-tax.firebasestorage.app",messagingSenderId:"788663710911",appId:"1:788663710911:web:33143712e512d6253c820a",measurementId:"G-LYGK290Y1Z"},Bh=Ru(KE),Br=yg(Bh),_i=PE(Bh);window.kodaEngine=(()=>{let n={currentUser:null,records:[],categories:[{id:"수입 합계",keywords:["애드센스","협찬","수입","입금","광고수익","도네","후원","정산"],type:"income",box:"수입"},{id:"식대",keywords:["식대","밥","회식","미팅","커피","편의점","식사"],type:"expense",box:"15"},{id:"여비교통비",keywords:["교통","차비","택시","버스","지하철","주유","기름","톨게이트","주차"],type:"expense",box:"15"},{id:"촬영소품",keywords:["소품","배경","의상","분장","액세서리","가발"],type:"expense",box:"11"},{id:"장비비",keywords:["장비","카메라","마이크","조명","렌즈","컴퓨터","PC","모니터","삼각대"],type:"expense",box:"22"},{id:"소프트웨어/구독",keywords:["구독","툴","프로그램","편집툴","클라우드","어도비","프리미어","라이선스","폰트"],type:"expense",box:"22"},{id:"외주/편집",keywords:["외주","편집","디자인","썸네일","컷편집","제작비"],type:"expense",box:"21"},{id:"통신비",keywords:["통신","인터넷","휴대폰","요금제"],type:"expense",box:"19"},{id:"소모품비",keywords:["소모품","사무용품","펜","종이","문구","건전지"],type:"expense",box:"22"},{id:"수선유지비",keywords:["수선","유지","수리","보수","수리비"],type:"expense",box:"22"},{id:"월세/임차료",keywords:["월세","임대료","임차료","관리비","스튜디오"],type:"expense",box:"13"},{id:"수도광열비",keywords:["수도","전기","가스","난방","냉난방"],type:"expense",box:"18"},{id:"보험료",keywords:["보험","국민연금","건강보험","자동차보험","산재"],type:"expense",box:"15"},{id:"세금과공과",keywords:["세금","면허세","재산세","공과금","범칙금"],type:"expense",box:"20"},{id:"지급수수료",keywords:["수수료","뱅킹수수료","결제수수료","이체수수료"],type:"expense",box:"21"},{id:"광고선전비",keywords:["광고","홍보","마케팅"],type:"expense",box:"22"},{id:"기타필요경비",keywords:[],type:"expense",box:"22"}],lastDetected:null,recognition:null,isAuthInitialized:!1,voiceTargetYear:null,currentYear:new Date().getFullYear(),allRecords:[],activeReportType:null};const e=m=>document.getElementById(m),t=m=>new Intl.NumberFormat("ko-KR").format(Math.floor(m)),r=(m,E="success")=>{let A=e("app-toast");A||(A=document.createElement("div"),A.id="app-toast",document.body.appendChild(A)),A.innerText=m,A.className=`toast-visible ${E}`,setTimeout(()=>A.className="",3e3)},s={11:{label:"매입비용(촬영소품)",scope:"콘텐츠 촬영용 소품, 의상, 배경지 등"},13:{label:"임차료(스튜디오)",scope:"사업장/스튜디오 월세 및 관리비"},14:{label:"접대비(미팅식대)",scope:"비즈니스 식대 및 협력자 선물"},15:{label:"복리후생비(식대)",scope:"본인 외 인력 식대, 음료"},17:{label:"여비교통비",scope:"택시비, 기차표, 대중교통"},19:{label:"통신비",scope:"인터넷 요금, 업무용 휴대폰"},21:{label:"지급수수료",scope:"컷편집, 썸네일 제작 외주비"},22:{label:"장비/광고/기타",scope:"카메라, 광고비, 어도비 구독료, 소모품"}},o=m=>{window.location.hash=m==="/"?"#/":`#${m}`,a()},a=()=>{const m=window.location.hash||"#/",E=e("user-type-overlay"),A=e("app-container");!E||!A||n.isAuthInitialized&&(m==="#/dashboard"||m.startsWith("#/dashboard")?n.currentUser?(E.style.display="none",A.style.display="flex",u()):o("/"):(E.style.display="flex",A.style.display="none"))},u=()=>{if(n.currentUser){const A=e("user-status-indicator"),C=e("logged-in-user-id");A&&(A.style.display="block"),C&&(C.innerText=n.currentUser.email.split("@")[0])}const m=e("history-list-mvp");if(!m)return;const E=n.records.slice(0,10);E.length===0?m.innerHTML='<tr><td colspan="5" class="empty-row">기록이 없습니다.</td></tr>':m.innerHTML=E.map(A=>`
                <tr>
                    <td class="cell-date">${A.date.slice(5).replace("-","/")}</td>
                    <td class="cell-type ${A.type}">${A.type==="income"?"수입":"경비"}</td>
                    <td class="cell-cat">${A.label||A.category}</td>
                    <td class="cell-amt">${t(A.amount)}원</td>
                    <td style="text-align:right;"><button class="delete-btn" onclick="kodaEngine.deleteRecord('${A.id}')">✕</button></td>
                </tr>
            `).join("")},h=async()=>{console.log("유튜버 종합소득세 신고앱 시작 (v1046)"),localStorage.getItem("app_v")!=="v1046"&&(localStorage.setItem("app_v","v1046"),console.log("v1046 Reset")),window.location.hash!=="#/"&&(window.location.hash="#/"),om(Br,m=>{if(n.currentUser=m,n.isAuthInitialized=!0,m){const E=BE(ou(_i,"users",m.uid,"records"),qE("date","desc"));WE(E,A=>{const C=A.docs.map(V=>({id:V.id,...V.data()}));n.allRecords=C,n.records=C.filter(V=>V.date&&V.date.startsWith(n.currentYear.toString()+"-")),u(),n.activeReportType==="current"?window.kodaEngine.showYearlyCategorySummary():n.activeReportType==="prev"&&window.kodaEngine.showPrevYearSummary()})}a()}),window.addEventListener("hashchange",a)},d=m=>{let E=0,A=m.replace(/[\s,]/g,"").replace(/원$/g,"");const C=A.match(/([\d\.]+)\s*억/);C&&(E+=parseFloat(C[1])*1e8);const V=A.match(/([\d\.]+)\s*천만/);V&&(E+=parseFloat(V[1])*1e7);const D=A.match(/([\d\.]+)\s*백만/);D&&(E+=parseFloat(D[1])*1e6);const B=A.match(/([\d\.]+)\s*(?!천만|백만)만/);if(B&&(E+=parseFloat(B[1])*1e4),E===0){const q=A.replace(/[^0-9]/g,"");q&&(E=parseInt(q))}return E},p=m=>{const E=d(m);let A="기타필요경비";const C=m.toLowerCase();return C.includes("광고")||C.includes("마케팅")||C.includes("22번")?A="광고선전비":C.includes("식대")||C.includes("식비")||C.includes("15번")?A="식대":C.includes("교통")||C.includes("택시")||C.includes("17번")?A="여비교통비":C.includes("월세")||C.includes("임차")||C.includes("13번")?A="월세/임차료":(C.includes("장비")||C.includes("촬영")||C.includes("11번"))&&(A="촬영소품"),{type:A==="수입 합계"?"income":"expense",category:A,label:m.split(/[0-9]|만|원/)[0].trim()||A,amount:E,status:"준비"}};return{init:h,login:async m=>{m&&m.preventDefault();const E=e("login-id").value.trim(),A=e("login-pw").value.trim(),C=E.includes("@")?E:`${E}@coda-tax.com`;await rm(Br,C,A),o("/dashboard")},loginWithGoogle:async()=>{const m=new He;await Pm(Br,m),o("/dashboard")},logout:async()=>{confirm("로그아웃?")&&(await am(Br),window.location.reload())},startVoiceRecord:(m=null)=>{const E=window.SpeechRecognition||window.webkitSpeechRecognition;E&&(n.voiceTargetYear=m,e("voice-modal").style.display="flex",e("voice-transcribed-text").innerText="...기다리는 중",e("voice-result-box").style.display="none",n.recognition||(n.recognition=new E,n.recognition.lang="ko-KR",n.recognition.onresult=A=>{const C=A.results[A.results.length-1][0].transcript;e("voice-transcribed-text").innerText=C,n.lastDetected=p(C),e("voice-result-box").style.display="block"}),n.recognition.start())},confirmVoiceEntry:async()=>{if(!n.lastDetected)return;const m={...n.lastDetected};m.date=n.voiceTargetYear?`${n.voiceTargetYear}-12-31`:new Date().toISOString().split("T")[0],await HE(ou(_i,"users",n.currentUser.uid,"records"),m),e("voice-modal").style.display="none",r("실적이 성공적으로 기록되었습니다! 🎉")},deleteRecord:async m=>{confirm("삭제?")&&await zE(Sh(_i,"users",n.currentUser.uid,"records",m))},showYearlyCategorySummary:()=>{n.activeReportType="current";const m=n.records,E={};m.forEach(C=>{var B;const V=n.categories.find(q=>q.id===C.category)||{box:"22"},D=`[${V.box}] ${((B=s[V.box])==null?void 0:B.label)||"기타"}`;E[D]=(E[D]||0)+Number(C.amount)});let A='<div style="font-size:0.9rem; position:relative;">';A+='<div style="position:absolute; top:-40px; right:0; font-size:10px; opacity:0.3; color:white;">v1046</div>',A+=`<div style="background:rgba(59,130,246,0.1); padding:20px; border-radius:16px; margin-bottom:20px; text-align:center;">
            ...
            </div>`,Object.keys(E).forEach(C=>{A+=`<div style="display:flex; justify-content:space-between; padding:10px 0; border-bottom:1px solid var(--border-color);"><span>${C}</span><span>${t(E[C])}원</span></div>`}),A+="</div>",e("report-title").innerText=`${n.currentYear}년 실적`,e("report-content").innerHTML=A,e("report-modal").style.display="flex"},showPrevYearSummary:()=>{n.activeReportType="prev";const m=n.currentYear-1,E=n.allRecords.filter(V=>V.date.startsWith(m+"-")),A={};E.forEach(V=>{var q;const D=n.categories.find(K=>K.id===V.category)||{box:"22"},B=`[${D.box}] ${((q=s[D.box])==null?void 0:q.label)||"기타"}`;A[B]=(A[B]||0)+Number(V.amount)});let C='<div style="font-size:0.9rem; position:relative;">';C+='<div style="position:absolute; top:-40px; right:0; font-size:10px; opacity:0.3; color:white;">v1046</div>',C+=`<div style="background:rgba(59,130,246,0.1); padding:20px; border-radius:16px; margin-bottom:20px; text-align:center;">
                <button onclick="kodaEngine.openBulkModal('${m}')" class="btn-primary" style="padding:10px 20px; font-weight:700;">🤖 AI 요약 가이드 열기</button>
            </div>`,Object.keys(A).forEach(V=>{C+=`<div style="display:flex; justify-content:space-between; padding:10px 0; border-bottom:1px solid var(--border-color);"><span>${V}</span><span>${t(A[V])}원</span></div>`}),C+="</div>",e("report-title").innerText=`${m}년 실적`,e("report-content").innerHTML=C,e("report-modal").style.display="flex"},closeReportModal:()=>e("report-modal").style.display="none",openBulkModal:m=>{n.voiceTargetYear=m,e("bulk-modal").style.display="flex",e("bulk-input-area").style.display="block"},copyGeminiPrompt:()=>{navigator.clipboard.writeText(`내가 결제한 1년 치 내역을 줄게. 아래 홈택스 경비 번호별로 각각 합계를 계산해서 요약해줘.
...
ChatGPT나 Gemini에 붙여넣으세요.`)}}})();window.addEventListener("DOMContentLoaded",()=>{var n;window.kodaEngine.init().catch(console.error),(n=get("close-bulk-modal"))==null||n.addEventListener("click",()=>get("bulk-modal").style.display="none")});
